(function ($) {
    ...
    if ($(".develor_tab_2 li a").length > 0) {
        $(".develor_tab_2 li a").click(function () {
            var tab_id = $(this).attr("data-tab");
            $(".tab_img_2").removeClass("active");
            $("#" + tab_id).addClass("active");
        });
    }
    if ($(".develor_tab_3 li a").length > 0) {
        $(".develor_tab_3 li a").click(function () {
            var tab_id = $(this).attr("data-tab");
            $(".tab_img_3").removeClass("active");
            $("#" + tab_id).addClass("active");
        });
    }
    if ($(".develor_tab_4 li a").length > 0) {
        $(".develor_tab_4 li a").click(function () {
            var tab_id = $(this).attr("data-tab");
            $(".tab_img_4").removeClass("active");
            $("#" + tab_id).addClass("active");
        });
    }
