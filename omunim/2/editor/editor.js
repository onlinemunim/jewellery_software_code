	...
	var methods = {
		...
		init : function( options )
		{
			...
			var $this = $(this).hide();	       	
	       	...
	       	var editor  = $( "<div/>",{ id:"iframeEditorMain",	class : "Editor-editor",
										css : {overflow: "auto"},
...
//alert($("#iframeEditorHiddenText").Editor("getText"));
                                    //$('#iframeEditorHiddenText').val($('#iframeEditorMain').text());
	       	...
	       	for(var item in menuItems){
	       		...
	       		if(item in menuGroups){
	       			...
	       			menuBar.append(menuItem);
                        ...
                        $(document.body).bind('focusout', function(){
