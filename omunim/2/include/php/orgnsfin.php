        ...
        <tr>
            ...
            <td align="right">
                <table border="0" cellspacing="0" cellpadding="0" align="right">
                    <tr>
                        <td align="left" class="textBoxCurve1px margin1pxAll textLabel16CalibriNormal backFFFFFF">
                            <div><?php
                                $panelName = 'InterestAnalysisPanel';
...
<div id="girvAnaMonthIntGraphDiv">
    <?php include 'orgnsfid.php'; ?>
</div>
