...
$dbColumnsArray = array(
    ...
    "CAST(girv_prin_amt_int AS SIGNED)",
...
$_SESSION['tableWhere'] = "girv_upd_sts IN ('New', 'Updated') and girv_firm_id IN ($strFrmId)";
// 
// Table Joins
