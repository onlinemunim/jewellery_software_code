 ...
 *
 * @FileName: omspNewItemReturnPrdDet.php
...
//            echo '$crystalPresent==>'.$crystalPresent.'<br>';
...
//                if ($noOfCry > 0) {
                   foreach ($getStockTransDetails as $rescrystal) {
                       if ($rescrystal['sttr_indicator'] == 'stockCrystal' && $rescrystal['sttr_sttr_id'] == $slPrId) {
...
//                $mainTotalGstAmt += $totalGstAmt;
                include 'omspnewItemReturnTblRight.php';
...
//            }
            $totalColumns;
            include 'omItemReturnpayinfo.php';
            ?>
            ...
            <table style="width:96%;margin:2px auto;background:#fff" class="billing-table2">
                ...
                <tbody class="table-innerSec">
                    <tr>
                        ...
                        <td align="center"><?php echo number_format($utin_total_taxable_amt, 2); ?></td>
                        ...
                        <td colspan="2" align="right" style="text-align: right;"><?php echo number_format($utin_tot_payable_amt, 2); ?></td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left" class="border-color-grey-bottom border-color-grey-top">
                                        ...
                                        if ($roundPlus != '' && $roundPlus != 0) {
                                            echo "$globalCurrency" . ' ' . ucwords(numToWords((abs($totalAmount + $roundPlus) + 0))) . ' Only/-';
