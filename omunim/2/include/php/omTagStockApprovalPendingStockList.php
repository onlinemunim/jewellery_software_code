 ...
 *               TAG APPROVAL PENDING STOCK LIST (MOVE TO STOCK) @Author:PRIYANKA-20JUNE2022
 * *************************************************************************************************
 *
 * Created on JUNE 20, 2022 01:33:00 PM 
 * **************************************************************************************
 * @FileName: omTagStockApprovalPendingStockList.php
 * @Author: SoftwareGen Developement Team
 * @AuthorEmailId:  info@softwaregen.com
 * @ProjectName: 2.7.162
 * @version: OMUNIM 2.7.162
 ...
 * @ModificaionHistory
 *  MODIFICATION DATE:
 *  AUTHOR: @Author:PRIYANKA-20JUNE2022
 *  REASON:
 *
 * 
 * Project Name: Online Munim ERP Accounting Software OMUNIM 2.7.162
 * Version: OMUNIM 2.7.162
...
?>
<div id="tagStockApprovalPendingStockListDiv">
<?php
//
...
// **********************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER - APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
// **********************************************************************************************
//
...
//
// *****************************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER - STOCK TRANSFER TO APPROVED LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************
if ($mainPanelName == 'tagApprovalPendingAddStock' && $transPanelName == 'reactive') {
    //
    include 'omStockTrasferApprovalPending.php';
    //
}
// *****************************************************************************************************
// END TO ADD CODE FOR STOCK TRANSFER - STOCK TRANSFER TO APPROVED LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************
//
//
// *****************************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER - STOCK TRANSFER TO APPROVED LIST @AUTHOR-PRIYANKA-23JUNE2022
// *****************************************************************************************************
if ($mainPanelName == 'tagStockTransferReturnStock' && $transPanelName == 'returnStock') {
    //
    include 'omStockTrasferReturnStock.php';
    //
}
// *****************************************************************************************************
// END TO ADD CODE FOR STOCK TRANSFER - STOCK TRANSFER TO APPROVED LIST @AUTHOR-PRIYANKA-23JUNE2022
// *****************************************************************************************************
//
?>
    ...
    <tr>
        ...
        <td valign="top" align="left" colspan="15">
            <a class="links" onclick=""
               style="cursor: pointer;" title="STOCK TRANSFER - PENDING APPROVAL LIST!">
        ...
        <?php
        //
        // Start Code for Message Display @Author:PRIYANKA-20JUNE2022
        //
        ?>
        ...
        <?php
        //
        // End Code for Message Display @Author:PRIYANKA-20JUNE2022
        //
        ?>    
...
//                    include $_SESSION['documentRootIncludePhp'] . '/formInputField/omInputField.php';
    ...
    $headingNameForPanel = 'STOCK TRANSFER PENDING APPROVAL LIST';
    //
    //
    ...
    // 
    // 
    // Start Code To GET Firm Details @Author:PRIYANKA-20JUNE2022
    if (isset($_GET['selFirmId'])) {
        $selFirmId = $_GET['selFirmId'];
    } else {
        // If not selected assign session firm @Author:PRIYANKA-20JUNE2022
    ...
    if ($selFirmId == NULL || $selFirmId == '' || $selFirmId == 'NotSelected') {
        ...
        $strFrmId = '0';
        // Set String for Public Firms @Author:PRIYANKA-20JUNE2022
    ...
    // End Code To GET Firm Details @Author:PRIYANKA-20JUNE2022
    //
    //
    include 'omdatatablesUnset.php';
    unset($_SESSION['deleteColumn']);
    unset($_SESSION['deleteColumnId']);
    unset($_SESSION['deleteColumnValue']);
    unset($_SESSION['deleteColumnFunction']);
    unset($_SESSION['deleteColumnFunctionPara1']);
    unset($_SESSION['deleteColumnFunctionPara2']);
    unset($_SESSION['deleteColumnFunctionPara3']);
    unset($_SESSION['deleteColumnFunctionPara4']);
    unset($_SESSION['deleteColumnFunctionPara5']);
    unset($_SESSION['deleteColumnFunctionPara6']);
           
    ?>
                <div style="text-align: right; padding: 5px">
                    <button id="toggleButton" class="frm-btn grayFont" onclick="unselectSelectCheckboxes()">SELECT ALL TO SEND APPROVAL</button>
                    <button onclick="approveMultiple()" class="frm-btn grayFont">SEND TO APPROVAL</button>
                </div>
   <?php 
    //
    //
    // Data Table Main Columns @Author:PRIYANKA-20JUNE2022
    $dataTableColumnsFields = array(
        array('dt' => 'PENDING PROD ID'),
        array('dt' => 'DATE'),
            array('dt' => 'T.DATE'),       //ADDED TRANSFER DATE @AUTHOR SIMRAN-19OCT2022
        array('dt' => 'PREV FIRM'),
        array('dt' => 'FIRM'),
        array('dt' => 'TYPE'),
        array('dt' => 'CATEGORY'),
   ...
   "$stock_date_col",
    ...
    "if((sttr_stock_transfer_approval_status='StockTransferApprovalPendingStock'),'APPROVAL PENDING',sttr_status)", 
    "sttr_id"
    );
    //
    //
    ...
    $_SESSION['sqlQueryColumns'] = "sttr_id, sttr_metal_type, sttr_transaction_type, sttr_indicator, sttr_status, "
                                 . "sttr_stock_transfer_previous_firm_id, sttr_stock_transfer_approval_status,";
    //
    //
    $_SESSION['dtSumColumn'] = '9,10,11,13,14';
    //$_SESSION['dtDeleteColumn'] = '15';
    $_SESSION['dtSortColumn'] = '';
    $_SESSION['dtASCDESC'] = '';
    //
    //
    // Start code to include all session @Author:PRIYANKA-20JUNE2022
    $_SESSION['colorfulColumn'] = "";
    $_SESSION['colorfulColumnCheck'] = '';
    $_SESSION['colorfulColumnTitle'] = '';
    //
    //
    // On Click Function Parameters @Author:PRIYANKA-20JUNE2022
    $_SESSION['onclickColumnImage'] = "delete16.png";
    $_SESSION['onclickColumn'] = "sttr_id"; // On which column
    $_SESSION['onclickColumnId'] = "sttr_id";
    $_SESSION['onclickColumnValue'] = "sttr_id";
    $_SESSION['onclickColumnFunction'] = "tagStockTransferReturnStock";
    $_SESSION['onclickColumnFunctionPara1'] = "sttr_id";
    $_SESSION['onclickColumnFunctionPara2'] = "sttr_transaction_type";
    $_SESSION['onclickColumnFunctionPara3'] = "tagStockTransferReturnStock";
    $_SESSION['onclickColumnFunctionPara4'] = "returnStock";
    $_SESSION['onclickColumnFunctionPara5'] = "sttr_metal_type";
    $_SESSION['onclickColumnFunctionPara6'] = "sttr_indicator";
    //
    //
    //
    // FOR ROLLBACK TO PREVIOUS STOCK FIRM @Author:PRIYANKA-20JUNE2022
    $_SESSION['onprintColumnImage'] = "releaseButt16.png"; // releaseButt16.png / active.png
    $_SESSION['onprintColumn'] = "CONCAT(sttr_item_pre_id,COALESCE(sttr_item_id, ''))"; // On which column
    $_SESSION['onprintColumnId'] = "sttr_id";
    $_SESSION['onprintColumnValue'] = "sttr_id";
    $_SESSION['onprintColumnFunction'] = "tagApprovalPendingAddStock";
    $_SESSION['onprintColumnFunctionPara1'] = "sttr_id";
    $_SESSION['onprintColumnFunctionPara2'] = "sttr_transaction_type";
    $_SESSION['onprintColumnFunctionPara3'] = "tagApprovalPendingAddStock";
    $_SESSION['onprintColumnFunctionPara4'] = "reactive";
    $_SESSION['onprintColumnFunctionPara5'] = "sttr_metal_type";
    $_SESSION['onprintColumnFunctionPara6'] = "sttr_indicator";
    //
    //
    //
    //
    // FOR DELETE DELETED STOCK @Author:PRIYANKA-20JUNE2022
...
//    } else{
//        $_SESSION['deleteColumnFunction'] = "tagStockTransferReturnStock";
//    }
//    //
//    $_SESSION['deleteColumnFunctionPara1'] = "tagStockTransferReturnStock "; // Panel Name
//    $_SESSION['deleteColumnFunctionPara2'] = "sttr_id";
//    $_SESSION['deleteColumnFunctionPara3'] = "sttr_transaction_type";
//    $_SESSION['deleteColumnFunctionPara4'] = "sttr_metal_type";
//    $_SESSION['deleteColumnFunctionPara5'] = "returnStock";
//    $_SESSION['deleteColumnFunctionPara6'] = "sttr_indicator";
    //
    //
    //
    //
    // Extra direct columns we need pass in SQL Query @Author:PRIYANKA-20JUNE2022
    // Commented Code of transaction type @Author:PRIYANKA-05AUG2022
     $_SESSION['tableWhere'] = "sttr_firm_id IN ($strFrmId) "
                            ...
                            . "and sttr_stock_transfer_approval_status = 'StockTransferApprovalPendingStock' "
                            . "and sttr_indicator NOT IN ('stockCrystal')"
                            . "and sttr_status NOT IN ('DELETED','NotDelFromStock') and sttr_stock_transfer_success_status NOT IN ('transferPending')";
    // 
    // 
    //echo '$_SESSION[tableWhere] == ' . $_SESSION['tableWhere'] . '<br />';
    // 
    // 
    // Table Joins @Author:PRIYANKA-20JUNE2022
      $_SESSION['tableJoin'] = " INNER JOIN firm AS f ON sttr_firm_id = f.firm_id " 
            ...
            ."INNER JOIN stock_transfer AS st ON sttr_pre_voucher_no = st.sttrans_pre_voucher_no AND sttr_voucher_no = st.sttrans_voucher_no AND sttr_item_code = st.sttrans_item_code";
    //
    //
    // Data Table Main File @Author:PRIYANKA-20JUNE2022
    include 'omdatatables.php';
    //
    //
    // **********************************************************************************************
    // END TO ADD CODE FOR STOCK TRANSFER - APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
    // **********************************************************************************************
    //
    //
    ?>
