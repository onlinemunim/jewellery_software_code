    ...
    <table border="0" cellspacing="0" cellpadding="5" align="center" width="100%">
        <tr>
            ...
            <td valign="middle" align="left">
                <div class="main_link_green"><b>ONE YEAR OLD LOANS</b></div>
            </td>
        </tr>
    </table>
<?php
...
<form name="srch_exp_girvi" id="srch_exp_girvi" 
    ...
    <table border="0" cellspacing="0" cellpadding="5" align="center" width="100%"><!------noPrint removed @Author:PRIYA29MAY14----------->
        <tr>
            ...
            <td valign="middle" align="left">
                <div class="main_link_red" style="font-weight:600;">EXPIRED LOAN LIST <span class="main_link_blue noPrint"><?php echo $noOfMonths; ?> Months Old Girvi List</span></div><!--Change @AUTHOR: SANDY29DEC13---->
            </td>
            ...
            <!-- ************************************************************************ -->
            <td valign="middle" align="left" width="60px"  class="noPrint">
                <table>
                    <tr>
            ...
            <!-- code modified by @AUTHOR: LINA27JUN2013  -->
            <!-- ************************************************************************ -->
            <td valign="middle" align="left"  class="noPrint" width="30px">
                <div id="expGirviSrchButt"><input type="submit" value="GO" class="frm-btn" style="border-radius:5px!important;background: #DCEAFF;color: #0F118A;border: 1px solid #7ab0fe;font-size: 15px;height:35px;margin-left:-10px;"/></div>
            </td>
            <td align="right" valign="top" width="120px" class="noPrint">
                <table>
                    <tr>  
                        <td  class="textBoxCurve1px backFFFFFF">
                            <input id="rowsPerPage" name="rowsPerPage" type="text" value="<?php echo $rowsPerPage; ?>" placeholder="No Of Rows" title="Enter number of girvi in List"
                                   ...
                                   onclick="this.value = ''" style="width:100%;height:30px;"/>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td align="right" valign="middle" width="17px"  class="noPrint">
                <div id="CustomerListButton" style="background: #ffebba;border: 1px solid #edcd7b;color: #e99a05;width:30px;height:30px;text-align: center;border-radius:5px!important;">
                    <a style="cursor: pointer;margin-top:5px;" onclick="javascript:numberOfRowsExiperedPanel('<?php echo $documentRoot; ?>', document.getElementById('rowsPerPage').value, '<?php echo $selFirmId; ?>', '<?php echo $sortKeyword; ?>', '1', '<?php echo $noOfMonths; ?>', '<?php echo $searchColumnName; ?>', '<?php echo $searchColumnValue; ?>', 'updateRows', 'ExpiredLoanList');">
                        <img src="<?php echo $documentRootBSlash; ?>/images/submit16.png"  title="Click Here to Display Number of Customers in this List" style='margin-top:5px;'/>
                    </a>
                </div>
            </td>
        </tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                if ($totalGirvi <= 0) {
                    ...
                    <tr id="girviPanelTrId" >
                        <td colspan="8">
                            <table border="0" cellspacing="0" cellpadding="0" align="center" width="99%" style="border:1px solid #c1c1c1;">
                                <tr style="background-color: #FFF2B0;">
...
//*****************************************Start to add code for customer father name @AUTHOR: SANT12JAN16 *******************************
                                ...
                                while ($rowLpLayoutDet = mysqli_fetch_array($resLpLayoutDet)) {
                                    ...
                                    if ($panelVal == 'true') {
                                        ...
                                        <td align="left" width="198px" class="border-color-grey-rb" title="<?php echo $fatherName; ?>" > <!-- changes in width @AUTHOR: SANDY6AUG13 //cust father name DISPLAY @AUTHOR: SANDY19JAN14 -->
                                            <div class="h5 spaceLeft5"><?php echo substr($gCustName, 0, 80); ?> </div>
                                        </td>
                                        <?php
                                    }
                                }
                                ...
                                while ($rowLpLayoutDet = mysqli_fetch_array($resLpLayoutDet)) {
                                    ...
                                    if ($panelVal == 'true') {
                                        ?> 
                                        <td align="right" width="140px" class="border-color-grey-rb" >
                                            <div class="h5"><?php
                        ...
                        <!--                        <td align="right"  >
                                ...
                                <td align="center" class="border-color-grey-b" width="140px">
                                    <table>
                                        <tr>
            ...
            while ($rowLpLayoutDet = mysqli_fetch_array($resLpLayoutDet)) {
                ...
                if ($panelVal == 'true') {
                    ...
                    <td class="h5 border-color-grey-rb heightPX15">
                        <div class="h5 spaceRight15 paddingTop2" style="font-size:16px;"><b>TOTAL</b></div>
                    </td>
                    <?php
                }
            }
            ...
            while ($rowLpLayoutDet = mysqli_fetch_array($resLpLayoutDet)) {
                ...
                if ($panelVal == 'true') {
                    ...
                    <td title="Total Principal Amount of This Page!" class="h5 border-color-grey-rb heightPX15">
                        <div class="h5 spaceRight15 paddingTop2" style="font-size:16px;"><b><?php echo number_format($totExpPrin, 2); ?></b></div>
                    </td>
                    <?php
                }
            }
