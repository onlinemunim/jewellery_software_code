...
?>
<!---------Start code to change file @OMMODTAG SHRI_12AUG15-------------------------------->
 <div id="udhaarSrchDetPanel">
<?php
//Udhaar Fixed Amount Range
$udhaarAmtRange = $_POST['udhaarAmtRange'];

if ($udhaarAmtRange == '') {
    $udhaarAmtRange = $_GET['udhaarAmtRange'];
}

switch ($udhaarAmtRange) {
...
$qSelTotalUdhaarCount = "SELECT utin_id FROM user_transaction_invoice where utin_owner_id='$_SESSION[sessionOwnerId]' and utin_total_amt>='$startRange' and utin_total_amt<='$endRange' and utin_type = 'udhaar' and utin_status IN ('New','Updated') LIMIT $perOffset, $checkNextRows";
$resTotalUdhaarCount = mysqli_query($conn,$qSelTotalUdhaarCount);
$totalUdhaar = mysqli_num_rows($resTotalUdhaarCount);
//
$qSelAllUdhaar = "SELECT * FROM user_transaction_invoice where utin_owner_id='$_SESSION[sessionOwnerId]' and utin_total_amt>='$startRange' and utin_total_amt<='$endRange' and utin_type = 'udhaar' and utin_status IN ('New','Updated') order by utin_since desc LIMIT $perOffset, $rowsPerPage";
                            ...
                            if ($pageNum > 1) {
                                ...
                                <td align="right">
                                    <form name="prev_udhaar" id="prev_udhaar"
                                          action="javascript:navigationUdhaarSearchPanel(<?php echo "$pageNum - 1"; ?>,'<?php echo $rowsPerPage; ?>','','<?php echo $udhaarAmtRange; ?>');"
...
<!---------End code to change file @OMMODTAG SHRI_12AUG15-------------------------------->
