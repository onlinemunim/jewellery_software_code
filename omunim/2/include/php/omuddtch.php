...
//    FROM udhaar where udhaar_own_id='$_SESSION[sessionOwnerId]' and udhaar_type!='OnPurchase'";
$qSelAllUdhaar = "SELECT udhaar_id,udhaar_cust_id,udhaar_firm_id,udhaar_amt,udhaar_cust_fname,udhaar_cust_lname,udhaar_DOB,udhaar_DOR
    FROM udhaar where udhaar_own_id='$_SESSION[sessionOwnerId]' and udhaar_slprin_id IS NULL";//Query changed OnPurchase removed @Author:PRIYA17NOV14
