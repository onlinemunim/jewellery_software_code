...
/*
 * **************************************************************************************
 * @tutorial: SCHEME COMPLETE STATUS CHANGING POPUP FILE @AUTHOR: HEMA25FEB2020
 * **************************************************************************************
 * 
        ...
        <div class="grey-back">
            ...
            <div id="itemDelStatuschangediv">
                <table class="border-color-grey" border="0" cellspacing="2" cellpadding="2" width="100%" style="margin-top: 30px;">
                    ...
                    $kitty_mondep_admin_approve_status = $rowProductDetails['kitty_mondep_admin_approve_status'];
                    ?>
                    <tr>
                        ...
                        <td align="center" class="ff_calibri fs_14 brown" title="APPROVE STATUS">
                            <div class="fs_14 bold brown">COMPLETE STATUS</div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="overflow: hidden;border-top: 1px solid silver" align="center" class="brwnCalibri13Font" title="AMOUNT">
                            <div class="spaceRight5"><?php echo $kitty_mondep_admin_approve_status; ?></div>
                                <input type="hidden" id="documentRootPath" name="documentRootPath" class="select_border_grey" value="<?php echo $documentRootBSlash;?>">
                             <input type="button" id="completeBtn" name="completeBtn" value="COMPLETE"  onclick="changeSchemeCompleteStatus('<?php echo $kittyMondepId; ?>', 'COMPLETE');" /> 
                        </td>
                    </tr>
                </table>
            </div>
