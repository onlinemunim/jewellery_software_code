 ...
 *
 * @FileName: omspinvnewtaxheader.php
...
//                                    parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                                    ...
                                    <td align="left" style="width:100%;">
                                        ...
                                        parse_str(getTableValues("SELECT label_field_check as userPrefixNameCheck,label_field_font_size as userPrefixNameSize ,label_field_font_color as userPrefixNameColor FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                                        // 
                                        ?>
                                        <span style="font-size: <?php echo $userPrefixNameSize; ?>px;"><?php
                                            if ($user_prefix_name != NULL && $userPrefixNameCheck == 'true') {
                                                echo $user_prefix_name . '&nbsp ';
                                            }
                                            ?><?php ?> </span>
...
//                                    parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                    ...
                    ?>
                    <td class="customerDetails" style="margin-right:10px;">
                        <table style="margin-left: 1px;" border="0" width="100%">
                            <!--***************************************************************-->
                            <tr>
...
//                        parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                            ...
                            <?php
                            $pickupaddress = "SELECT omly_value FROM omlayout WHERE omly_option = 'pickupaddress'";
                            $respickupaddress = mysqli_query($conn, $pickupaddress);
                            $rowSetpickupaddress = mysqli_fetch_array($respickupaddress);
                            $pickupaddress_val = $rowSetpickupaddress['omly_value'];

                            $pickupservice = "SELECT omly_value FROM omlayout WHERE omly_option = 'pickupservice'";
                            $respickupservice = mysqli_query($conn, $pickupservice);
                            $rowSetpickupservice = mysqli_fetch_array($respickupservice);
                            $pickupservice_val = $rowSetpickupservice['omly_value'];

                            $showhide = "SELECT omly_value FROM omlayout WHERE omly_option = 'showhide'";
                            $resshowhide = mysqli_query($conn, $showhide);
                            $rowSetshowhide = mysqli_fetch_array($resshowhide);
                            $showhide_val = $rowSetshowhide['omly_value'];

                            if ($pickupaddress_val != null && $pickupaddress_val != '' && $showhide_val == 'YES' && $utin_show_hide_pickup === 'checked') {
                                ?>
                                <!-- START CODE TO SHOW PICKUP DETAILS ON INVOICE @GANESH 28 MAR 2025 -->
                                <tr>
                                    <td align="right" colspan="3">
                                        <table style="margin-left: 1px;" border="0">
                                            <!--***************************************************************-->
                                            <tr>
                                                <td align="left" >
                                                    <span style="color:#D23100;font-weight: bold;font-size:<?php echo $invNoTitleLb_size; ?>px;">
                                                        Pickup Address:
                                                    </span> 
                                                </td>
                                            </tr>
                            ...
                            ?>  
                            <!-- END CODE TO SHOW PICKUP DETAILS ON INVOICE @GANESH 28 MAR 2025 -- -->
                        </table>
                    </td>
                </tr>
            </table>    
