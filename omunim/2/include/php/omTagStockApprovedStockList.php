...
/*
 * *************************************************************************************************
 * @Description: STOCK TRANSFER - APPROVED LIST
 *               TAG APPROVED STOCK LIST (ADDED TO STOCK) @Author:PRIYANKA-20JUNE2022
 * *************************************************************************************************
 *
 * Created on JUNE 20, 2022 01:33:00 PM 
 * **************************************************************************************
 * @FileName: omTagStockApprovedStockList.php
...
?>
<div id="tagStockApprovedStockListDiv">
<?php
//
//
// **********************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER - APPROVED LIST @AUTHOR-PRIYANKA-21JUNE2022
// **********************************************************************************************
//
//
...
//
// *****************************************************************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER - DELETE STOCK FROM APPROVED LIST TRANSFER TO APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************************************************
if ($sttrId != '' && $sttrId != NULL) {
    //
    //echo 'mainPanelName @==@ ' . $mainPanelName . '</br>';
    //
    include 'omStockTrasferApprovedStockDel.php';
    //
    //
}
// *****************************************************************************************************************************************
// END TO ADD CODE FOR STOCK TRANSFER - DELETE STOCK FROM APPROVED LIST TRANSFER TO APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************************************************
//
//
    ...
    <tr>
        ...
        <td valign="top" align="left" width="50%">
            <a class="links" onclick=""
               style="cursor: pointer;" title="STOCK TRANSFER - APPROVED LIST!">
...
//                    include $_SESSION['documentRootIncludePhp'] . '/formInputField/omInputField.php';
    ...
    $headingNameForPanel = 'STOCK TRANSFER APPROVED LIST';
    //
    //
    ...
    "if((sttr_stock_transfer_approval_status='StockTransferApprovedStock'),'STOCK APPROVED',sttr_status)",    
    "sttr_id"
    );
    //
    //
    ...
    if (($staffId != '' && $array['deleteTransactionForAllPanel'] == 'false')){
        ...
        $_SESSION['deleteColumnFunction'] = "tagStockApprovedDel";
    }
    //
    $_SESSION['deleteColumnFunctionPara1'] = "tagStockApprovedDel "; // Panel Name
    ...
    $_SESSION['deleteColumnFunctionPara5'] = "tagStockApprovedDel";
    ...
    $_SESSION['tableWhere'] = "sttr_firm_id IN ($strFrmId) "
            ...
            . "and sttr_stock_transfer_approval_status = 'StockTransferApprovedStock' "
...
// 
    ...
    //
    // **********************************************************************************************
    // END TO ADD CODE FOR STOCK TRANSFER - APPROVED LIST @AUTHOR-PRIYANKA-21JUNE2022
    // **********************************************************************************************
    //
    //
    ?>
