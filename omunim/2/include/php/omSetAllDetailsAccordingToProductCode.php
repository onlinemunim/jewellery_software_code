...
/*
 * ********************************************************************************************************
 * @tutorial: START CODE TO ADD FILE TO SET ALL DETAILS ACCORDING TO PRODUCT CODE @AUTHOR-PRIYANKA-25AUG2020
 * ********************************************************************************************************
 * 
 * Created on AUG 25, 2020 02:12:13 PM
 *
 * @FileName: omSetAllDetailsAccordingToProductCode.php
...
if ($sttr_item_pre_id == '' || $sttr_item_pre_id == NULL) {
    $sttr_item_pre_id = $prodCode;
}
//
//
//if ($sttr_item_code != '' && $sttr_item_code != NULL) { ?>
<img src="<?php echo $documentRoot; ?>/images/spacer.gif" alt=""
     onload="allDetDisplayAccordingToProductCode('<?php echo $sttr_item_pre_id; ?>', '<?php echo $sttr_item_id; ?>',
