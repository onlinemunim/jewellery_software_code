<?php
/***************************************************************************************************
 * @Description: OPENING BOOK OUTWARD STOCK CALCULATE FOR RFID TAG FILE @AUTHOR:RENUKA SHARMA
 * **************************************************************************************************
  * @FileName: omStockTallySummaryOpeningBookOutwardCal.php
...
//
//***********************************************************************************************************
// START CODE FOR STOCK TALLY RFID TAG DATA CALCULATE-OPENING OUTWARD 
//***********************************************************************************************************
//
//
$OutwardBookQTYOp = 0;
...
//
//
// START CODE TO GET OUTWARD QTY, GS WEIGHT, NET WEIGHT FOR MG, GM, KG, CT
...
//
//
// IF TRANSACTION TYPE IS PURBYSUPP 
if ((($rowStockReportMainQuery['rfidtly_transaction_type'] == 'PURBYSUPP' ||
      $rowStockReportMainQuery['rfidtly_transaction_type'] == 'PURONCASH' ||  
      $rowStockReportMainQuery['rfidtly_transaction_type'] == 'EXISTING') &&
      $rowStockReportMainQuery['rfidtly_stock_type'] == 'wholesale')) {
    //
    //
    // START CODE TO GET TAG QTY, GS WEIGHT, NET WEIGHT FOR MG, GM, KG, CT
...
//
//***********************************************************************************************************
// END CODE  FOR STOCK TALLY RFID TAG DATA CALCULATE-OPENING OUTWARD
//***********************************************************************************************************
//
//
?>
