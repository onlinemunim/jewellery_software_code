...
/*
 * ***************************************************************************************
 * @tutorial: UNIVERSAL PENDING ORDER LIST @Darshana 12 AUG 2021
 * **************************************************************************************
 * Created on 12 aug 2021 12:45pm
 *
 * @FileName: omUniversalPendingOrderList.php
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td valign="middle" align="left" width="50%">
                <div class="main_link_orange16" style="color:#dc143c !important;">PENDING ORDER LIST<span class="textLabel14CalibriGreyMiddle">
...
$_SESSION['onclickColumn'] = "CONCAT(u.user_fname,' ',u.user_lname)"; // On which column
...
$_SESSION['onclickColumnFunctionPara3'] = "newOrderPendingList";
...
$_SESSION['onclickColumnFunctionTwoPara3'] = "newOrderPendingList";
...
//                        . "AND (sttr_direct_assign_status IS NULL OR sttr_direct_assign_status = '') "
//                        . "AND sttr_transaction_type = 'newOrder' AND sttr_status IN ('PaymentDone') ";
//
//
$_SESSION['tableWhere'] = "sttr_owner_id = '$_SESSION[sessionOwnerId]' AND sttr_firm_id IN ($strFrmId) "
                        . "AND sttr_stock_type = 'retail' AND sttr_indicator = 'stock' "
                        . "AND ((sttr_return_pre_invoice_no IS NULL OR sttr_return_pre_invoice_no = '') "
                        . "OR (sttr_direct_assign_status IS NOT NULL AND sttr_direct_assign_status != '')) "
                        . "AND sttr_transaction_type = 'newOrder' AND sttr_status IN ('PaymentDone') AND sttr_return_status!='RETURNED' ";
// 
// Table Joins
