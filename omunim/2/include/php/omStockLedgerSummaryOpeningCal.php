...
/*
 * **************************************************************************************************
 * @Description: STOCK LEDGER SUMMARY CALCULATE OPENING FILE @AUTHOR:PRIYANKA-14OCT2021
 * **************************************************************************************************
 *
...
//if ($Name == 'TOPS') {
//    
//echo '$openingStockDet == ' . $openingStockDet . '<br /><br />';
//    
//}
//
...
//  
//                                              
//if ($Name == 'TOPS' && $StockType == 'wholesale') {
...
//    echo '$total_only_sell_items == ' . $total_only_sell_items . '<br />';
////
////
//    echo '$OpeningGsWeightOp == ' . $OpeningGsWeightOp . '<br />';
//    echo '$OutwardGsWeightOpWoMisMatch == ' . $OutwardGsWeightOpWoMisMatch . '<br />';
//}
//
//
$OpeningQTY = ($OpeningQTYOp - $OutwardQTYOp);
$OpeningGsWeight = ($OpeningGsWeightOp - $OutwardGsWeightOpWoMisMatch);
$OpeningNtWeight = ($OpeningNtWeightOp - $OutwardNtWeightOpWoMisMatch);
