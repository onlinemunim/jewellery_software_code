 ...
 * **************************************************************************************
 * @FileName: omStockTallyMultibarcodeReportSummary.php
                ...
                <td valign="middle" align="left" width="0">
                    <a class="links" style="cursor: pointer;"
                       onclick="">
                        ...
                        <div class="textLabelHeading">STOCK TALLY REPORT FOR MULTIBARCODE </div>
                    </a>
                </td>
            </tr>
        </table>
...
<!--                <td valign="middle" align="center" class="frm-lbl" width="0%">
                ...
                <td align="center">
                    ...
                    <input id="goButton" name="goButton" type="button" style="margin-left: 16px;"
                           onclick="javascript:
                                           searchMultiBarcodeStockTallySummaryReportDetails(document.getElementById('FirmName').value, '<?php echo $panelName; ?>',
                                               document.getElementById('FromDay'), document.getElementById('FromMonth'), document.getElementById('FromYear'),
                                               document.getElementById('ToDateDay'), document.getElementById('ToDateMonth'), document.getElementById('ToDateYear'));
                                       return false;"
...
//            echo "todayFromStrDate:- ".$todayFromStrDate.'<br>'; // todayFromStrDate:- 1668796200 X 
                       ...
                       //===========================================================================================================
                       $dateRangeStrForOpening = "UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y'))=$todayFromStrDate";
                       $dateStrForOpening = "UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y'))=$todayFromStrDate";
                       //
                       $dateStr = "and UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y'))<=$todayFromStrDate";
                       $dateStrForTodayOutwards = "and UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y'))<=$todayFromStrDate";
                   } else {
...
//            $dateStrForOpening = "(UNIX_TIMESTAMP(STR_TO_DATE(rfidtly_scan_date,'%d %b %Y'))<=$todayFromStrDate) ";
                       $dateStrForOpening = "UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y')) BETWEEN $todayFromStrDate AND $todayToStrDate";
                       $dateStr = "and UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y')) BETWEEN $todayFromStrDate AND $todayToStrDate";
                       $dateStrForTodayOutwards = "and UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y')) BETWEEN $todayFromStrDate AND $todayToStrDate";
                   }
                       //
                  ...
                  // }
                   ...
                   $dateStrForOutwards = "and UNIX_TIMESTAMP(STR_TO_DATE(multi_barcode_scan_date,'%d %b %Y'))<=$todayFromStrDate ";
                   ...
                   if ($searchValueMetal != 'METAL' && $searchValueMetal != '' && $searchValueMetal != NULL) {
                       $searchByColumnMetalStr = " and multi_barcode_metal_type LIKE '$searchValueMetal%' ";
                   } else {
                   ...
                   if ($searchValueCategory != 'CATEGORY' && $searchValueCategory != '' && $searchValueCategory != NULL) {
                       $searchByColumnCategoryStr = " and multi_barcode_product_category LIKE '$searchValueCategory%' ";
                   } else {
                   ...
                   if ($searchValueName != 'NAME' && $searchValueName != '' && $searchValueName != NULL) {
                       $searchByColumnNameStr = " and multi_barcode_product_name LIKE '$searchValueName%' ";
                   } else {
...
//***********************************************************************************************************
                    $openingBookStockDetView = "CREATE TABLE IF NOT EXISTS TEMP_BARCODE_OPENING_BOOK_STOCK AS SELECT "
...
//***********************************************************************************************************
                   $openingStockDetView = "CREATE TABLE IF NOT EXISTS TEMP_BARCODE_OPENING_STOCK AS SELECT "
                           . "SUM(multi_barcode_quantity) AS OpeningQTYOp, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'MG', multi_barcode_gs_weight,0)) AS OpeningGsWeightMG, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'GM', multi_barcode_gs_weight,0)) AS OpeningGsWeightGM, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'KG', multi_barcode_gs_weight,0)) AS OpeningGsWeightKG, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'CT', multi_barcode_gs_weight,0)) AS OpeningGsWeightCT, "
                           . "SUM(IF(multi_barcode_nt_weight_type = 'MG', multi_barcode_nt_weight,0)) AS OpeningNtWeightMG, "
                           . "SUM(IF(multi_barcode_nt_weight_type = 'GM', multi_barcode_nt_weight,0)) AS OpeningNtWeightGM, "
                           . "SUM(IF(multi_barcode_nt_weight_type = 'KG', multi_barcode_nt_weight,0)) AS OpeningNtWeightKG, "
                           . "SUM(IF(multi_barcode_nt_weight_type = 'CT', multi_barcode_nt_weight,0)) AS OpeningNtWeightCT, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'MG', multi_barcode_fine_weight,0)) AS OpeningFnWeightMG, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'GM', multi_barcode_fine_weight,0)) AS OpeningFnWeightGM, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'KG', multi_barcode_fine_weight,0)) AS OpeningFnWeightKG, "
                           . "SUM(IF(multi_barcode_gs_weight_type = 'CT', multi_barcode_fine_weight,0)) AS OpeningFnWeightCT, "
                           . "multi_barcode_owner_id, multi_barcode_indicator, multi_barcode_product_category, multi_barcode_product_name, "
                           . "multi_barcode_stock_type, multi_barcode_purity, multi_barcode_metal_type, multi_barcode_firm_id , multi_barcode_reporting_preiod "
                           . "FROM multi_barcode_tally "
                           . "WHERE multi_barcode_owner_id = '$sessionOwnerId' "
                           . "and multi_barcode_firm_id IN ($strFrmId) "
                           . "and multi_barcode_indicator IN ('stock', 'AddInvoice', 'imitation', 'RetailStock', 'crystal', 'strsilver', 'rawMetal') "
                           . "and multi_barcode_transaction_type IN ('EXISTING', 'PURBYSUPP', 'PURONCASH', 'TAG') "
                           . " and multi_barcode_reporting_preiod IN ('DONE') "
                           . " and multi_barcode_tally_open_report IN ('Y') "
                           . "and (($dateStrForOpening) or ($dateRangeStrForOpening))"
                           . "GROUP BY multi_barcode_firm_id, multi_barcode_product_category, multi_barcode_product_name, multi_barcode_stock_type, multi_barcode_metal_type, multi_barcode_purity ";
//
...
//***********************************************************************************************************
                   $closingStockDetView = "CREATE TABLE TEMP_BARCODE_CLOSING_STOCK AS SELECT "
...
//***********************************************************************************************************
                   $outwardStockDetView = "CREATE TABLE IF NOT EXISTS TEMP_BARCODE_OPENING_OUTWARD_STOCK AS SELECT "
...
//***********************************************************************************************************
                   $todayOutwardStockDetView = "CREATE TABLE IF NOT EXISTS TEMP_BARCODE_TODAY_OUTWARD_STOCK AS SELECT "
...
//***********************************************************************************************************
                   $inwardStockDetView = "CREATE TABLE IF NOT EXISTS TEMP_BARCODE_INWARD_STOCK AS SELECT "
                           ...
                           . "GROUP BY sttr_firm_id, sttr_item_category, sttr_item_name, sttr_stock_type, sttr_metal_type, sttr_purity ";
//
//echo '$inwardStockDetView == 22 ' . $inwardStockDetView . '<br />';
//
...
//***********************************************************************************************************
                   // Start Code To Fetch All Records - Group By multi_barcode_product_category @AUTHOR:YUVRAJKAMBLE-11OCT2022
                   $stockReportMainQuery = "SELECT * FROM multi_barcode_tally WHERE multi_barcode_owner_id = '$sessionOwnerId' "
                           . "and multi_barcode_firm_id IN ($strFrmId) "
                           . "and multi_barcode_indicator IN ('AddInvoice', 'stock', 'imitation', 'RetailStock', 'crystal' , 'strsilver') "
                           . "and multi_barcode_status NOT IN ('DELETED','NotDelFromStock') "
                           . "and multi_barcode_transaction_type IN ('PURONCASH', 'PURBYSUPP', 'EXISTING', 'TAG') and "
                           . "multi_barcode_reporting_preiod = 'DONE' "
                           . "and multi_barcode_tally_open_report = 'Y' "
                           . " $finalSearchByColumnStr "
                           . "GROUP BY multi_barcode_firm_id, multi_barcode_product_category, multi_barcode_product_name, multi_barcode_stock_type, multi_barcode_metal_type, multi_barcode_purity "
                           . "ORDER BY multi_barcode_product_category, multi_barcode_product_name ASC ";
                   //
...
//          echo 'noOfRecordsAvailable == ' . $noOfRecordsAvailable . '<br />';
            ...
            while ($rowStockReportMainQuery = mysqli_fetch_array($resStockReportMainQuery)) {
                ...
                $Category = $rowStockReportMainQuery['multi_barcode_product_category'];
                //
                // NAME @AUTHOR:YUVRAJKAMBLE-11OCT2022
                $Name = $rowStockReportMainQuery['multi_barcode_product_name'];
                $FirmName = $rowStockReportMainQuery['multi_barcode_firm_id'];
                //
                // STOCK TYPE @AUTHOR:YUVRAJKAMBLE-11OCT2022
                $StockType = $rowStockReportMainQuery['multi_barcode_stock_type'];
                $multi_barcode_scan_status = $rowStockReportMainQuery['multi_barcode_scan_status'];
                //
                // PURITY @AUTHOR:YUVRAJKAMBLE-11OCT2022
                $Purity = $rowStockReportMainQuery['multi_barcode_purity'];
                //
                // INDICATOR @AUTHOR:YUVRAJKAMBLE-11OCT2022
                $Indicator = $rowStockReportMainQuery['multi_barcode_indicator'];
                //
                // METAL TYPE @AUTHOR:YUVRAJKAMBLE-11OCT2022
                $MetalType = $rowStockReportMainQuery['multi_barcode_metal_type'];
              //  echo '$MetalType=='.$MetalType;
                // multi_barcode_reporting_preiod @AUTHOR:YUVRAJKAMBLE-17112022
                $rfidtlyReportingPreiod = $rowStockReportMainQuery['multi_barcode_reporting_preiod'];
                $multi_barcode_scan_date = $rowStockReportMainQuery['multi_barcode_scan_date'];
                //
                //
                        ...
                        <td align="left" style="background-color: rgb(255, 227, 145) !important; width: 3%; border-top: 1px dashed #ce7300; border-bottom: 1px dashed #ce7300; width: 4%; ">
                            <div class="brown brownMess13Arial" style="font-size: 12px; margin-left: 5px;">
                                <input id="metalType" type="text" name="metalType" 
                                       ...
                                       value = "<?php
                                       if ($searchColumnMetal == 'multi_barcode_metal_type')
                                       ...
                                       onblur = "javascript:
                                                               ...
                                                               searchStockTallySummaryReportDetailsByColumn(document.getElementById('FirmName').value, '<?php echo $panelName; ?>',
                                                                       document.getElementById('FromDay'), document.getElementById('FromMonth'), document.getElementById('FromYear'),
                                                                       document.getElementById('ToDateDay'), document.getElementById('ToDateMonth'), document.getElementById('ToDateYear'),
                                                           'multi_barcode_metal_type', document.getElementById('metalType').value,
                                                           'multi_barcode_product_category', document.getElementById('itemCategory').value,
                                                           'multi_barcode_product_name', document.getElementById('itemName').value);
                                                               return false;
                                                           } else {
                                                               document.getElementById('metalType').value = '<?php
                                       if ($searchValueMetal == 'multi_barcode_metal_type')
                                           echo $searchValueMetal;
                                       else
                                           echo 'METAL';
                                       ?>';
                        ...
                        <td align="left" style="background-color: rgb(255, 227, 145) !important; width: 3%; border-top: 1px dashed #ce7300; border-bottom: 1px dashed #ce7300; width: 10%; ">
                            <div class="brown brownMess13Arial" style="font-size: 12px; margin-left: 5px;">
                                <input id="itemCategory" type="text" name="itemCategory" 
                                       ...
                                       value = "<?php
                                       if ($searchColumnCategory == 'multi_barcode_product_category')
                                       ...
                                       if ($searchValueCategory == 'multi_barcode_product_category')
                                           echo $searchValueCategory;
                                       else
                                           echo 'CATEGORY';
                                       ?>';
                        ...
                        <td align="left" style="background-color: rgb(255, 227, 145) !important; width: 3%; border-top: 1px dashed #ce7300; border-bottom: 1px dashed #ce7300; width: 10%; ">
                            <div class="brown brownMess13Arial" style="font-size: 12px; margin-left: 5px;">
                                <input id="itemName" type="text" name="itemName" 
                                       ...
                                       value = "<?php
                                       if ($searchColumnName == 'multi_barcode_product_name')
                                       ...
                                       if ($searchValueName == 'multi_barcode_product_name')
                                           echo $searchValueName;
                                       else
                                           echo 'NAME';
                                       ?>';
                ...
                //***********************************************************************************************************
                include 'omStocktallyBarcodeSummaryOpeningBookCal.php';
                //********************************************************************************************************
                // START CODE FOR STOCK RFID STOCKM TALLY  SUMMARY CALCULATE OPENING @AUTHOR:YUVRAJKAMBLE-29DEC2022
                //***********************************************************************************************************
                //
                include 'omStocktallyBarcodeSummaryOpeningCal.php';
                //
                //***********************************************************************************************************
...
//        include 'omStockLedgerSummaryInwardCal.php';
                include 'omStocktallyBarcodeSummaryInwardCal.php';
                //                                               
                //***********************************************************************************************************
...
//        include 'omStockLedgerSummaryOutwardCal.php';
                include 'omStocktallyBarcodeSummaryOutwardCal.php';
                //
                //***********************************************************************************************************
                ...
                if ($OpeningGsWeight > 0 || $InwardGsWeight > 0 || $OutwardGsWeight > 0) {
                    ?>
                    <tr>
                    <div id = "myModal<?php echo $rowStockReportMainQuery['multi_barcode_id']; ?>" class = "modal"></div>
                    ...
                    <td colspan="6" align="center" style="font-size: 13px;background-color: rgb(221, 221, 221); width: 40%;">
                        <table align="center" border="0" cellspacing="0" cellpadding="0" width="100%" 
                            ...
                            <tr>
                                ...
                                <td align="right" style="padding-right: 5px; width: 40%;">
                                    <div>
                                        <?php if ($OpeningGsWeight > 0) { ?>
                                            <a style="cursor: pointer;" 
                                               onclick="getStockSummaryTransactionsReportPopUpRfidTally('<?php echo $rowStockReportMainQuery[multi_barcode_rfid_id]; ?>', '<?php echo $todayFromStrDate; ?>', '<?php echo $todayToStrDate; ?>', '<?php echo strtoupper($startDate); ?>', '<?php echo strtoupper($endDate); ?>', '<?php echo $strFrmId; ?>', '<?php echo $Category; ?>', '<?php echo $Name; ?>', '<?php echo $StockType; ?>', '<?php echo $Purity; ?>', 'OpeningDetails', '<?php echo $documentRoot; ?>', 'StockReportRfidPanel', '<?php echo $rowStockReportMainQuery[multi_barcode_product_code]; ?>');">
                                                   <?php
                                                   // OPENING GS WT @AUTHOR:YUVRAJKAMBLE-11OCT2022
                                ...
                                <?php
                                //echo 'multi_barcode_id *==* ' . $rowStockReportMainQuery['multi_barcode_id']; 
                                ?>
...
//                                   include 'omStockTallySummaryClosingCal.php';
                                   include 'omStockTallyBarcodeSummaryClosingBookCal.php';
                                   //
                                   //
                                   //***********************************************************************************************************
                                   ...
                                   $stockReportMainQueryLast = "SELECT "
                                           . "SUM(multi_barcode_quantity) AS ClosingBarcodeTallyQTYOp, "
                                           . "SUM(multi_barcode_gs_weight) AS ClosingBarcodeTallyTotalGsWeight, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'MG', multi_barcode_gs_weight,0)) AS ClosingBarcodeTallyGsWeightMG, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'GM', multi_barcode_gs_weight,0)) AS ClosingBarcodeTallyGsWeightGM, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'KG', multi_barcode_gs_weight,0)) AS ClosingBarcodeTallyGsWeightKG, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'CT', multi_barcode_gs_weight,0)) AS ClosingBarcodeTallyGsWeightCT, "
                                           . "SUM(IF(multi_barcode_nt_weight_type = 'MG', multi_barcode_nt_weight,0)) AS ClosingBarcodeTallyNtWeightMG, "
                                           . "SUM(IF(multi_barcode_nt_weight_type = 'GM', multi_barcode_nt_weight,0)) AS ClosingBarcodeTallyNtWeightGM, "
                                           . "SUM(IF(multi_barcode_nt_weight_type = 'KG', multi_barcode_nt_weight,0)) AS ClosingBarcodeTallyNtWeightKG, "
                                           . "SUM(IF(multi_barcode_nt_weight_type = 'CT', multi_barcode_nt_weight,0)) AS ClosingBarcodeTallyNtWeightCT, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'MG', multi_barcode_fine_weight,0)) AS ClosingBarcodeTallyFnWeightMG, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'GM', multi_barcode_fine_weight,0)) AS ClosingBarcodeTallyFnWeightGM, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'KG', multi_barcode_fine_weight,0)) AS ClosingBarcodeTallyFnWeightKG, "
                                           . "SUM(IF(multi_barcode_gs_weight_type = 'CT', multi_barcode_fine_weight,0)) AS ClosingBarcodeTallyFnWeightCT "
                                           . "FROM multi_barcode_tally "
                                           . "WHERE multi_barcode_owner_id = '$sessionOwnerId' "
                                           ...
                                           . "and multi_barcode_reporting_preiod = 'DONE' "
                                           . "and multi_barcode_tally_close_report = 'Y' "
...
//        echo $noOfRecordsAvailableLast;
                            ...
                            <tr>
                              ...
                              //  while ($rowStockReportMainQueryLast = mysqli_fetch_array($resStockReportMainQueryLast)) {
                                    //
                                    $ClosingBarcodeTallyQTYOp = $rowStockReportMainQueryLast['ClosingBarcodeTallyQTYOp'];
                                    $ClosingBarcodeTallyTotalGsWeight = $rowStockReportMainQueryLast['ClosingBarcodeTallyTotalGsWeight'];
                                    //
                                    $ClosingBarcodeTallyGsWeightMG = $rowStockReportMainQueryLast['ClosingBarcodeTallyGsWeightMG'];
                                    $ClosingBarcodeTallyGsWeightGM = $rowStockReportMainQueryLast['ClosingBarcodeTallyGsWeightGM'];
                                    $ClosingBarcodeTallyGsWeightKG = $rowStockReportMainQueryLast['ClosingBarcodeTallyGsWeightKG'];
                                    $ClosingBarcodeTallyGsWeightCT = $rowStockReportMainQueryLast['ClosingBarcodeTallyGsWeightCT'];
                                    //
                                    $totalGswt = $ClosingBarcodeTallyGsWeightMG + $ClosingBarcodeTallyGsWeightGM + $ClosingBarcodeTallyGsWeightKG + $ClosingBarcodeTallyGsWeightCT;
                                    $totalGswt = decimalVal($totalGswt, 2);
                                    //
                                    $ClosingBarcodeTallyNtWeightMG = $rowStockReportMainQueryLast['ClosingBarcodeTallyNtWeightMG'];
                                    $ClosingBarcodeTallyNtWeightGM = $rowStockReportMainQueryLast['ClosingBarcodeTallyNtWeightGM'];
                                    $ClosingBarcodeTallyNtWeightKG = $rowStockReportMainQueryLast['ClosingBarcodeTallyNtWeightKG'];
                                    $ClosingBarcodeTallyNtWeightCT = $rowStockReportMainQueryLast['ClosingBarcodeTallyNtWeightCT'];
                                    //
                                    $totalNtwt = $ClosingBarcodeTallyNtWeightMG + $ClosingBarcodeTallyNtWeightGM + $ClosingBarcodeTallyNtWeightKG + $ClosingBarcodeTallyNtWeightCT;
                                    $totalNtwt = decimalVal($totalNtwt, 2);
                                    //
                                    $ClosingBarcodeTallyFnWeightMG = $rowStockReportMainQueryLast['ClosingBarcodeTallyFnWeightMG'];
                                    $ClosingBarcodeTallyFnWeightGM = $rowStockReportMainQueryLast['ClosingBarcodeTallyFnWeightGM'];
                                    $ClosingBarcodeTallyFnWeightKG = $rowStockReportMainQueryLast['ClosingBarcodeTallyFnWeightKG'];
                                    $ClosingBarcodeTallyFnWeightCT = $rowStockReportMainQueryLast['ClosingBarcodeTallyFnWeightCT'];
                                    //
                                    $totalFnwt = $ClosingBarcodeTallyFnWeightMG + $ClosingBarcodeTallyFnWeightGM + $ClosingBarcodeTallyFnWeightKG + $ClosingBarcodeTallyFnWeightCT;
                                    $totalFnwt = decimalVal($totalNtwt, 2);
                                    //
                                     $totalClosingScanQty += $ClosingBarcodeTallyQTYOp;
                                ...
                                <td align="left" style="padding-left: 4px; width: 22%;">
                                    <div>
                                        <?php
                                        // CLOSING QTY @AUTHOR:YUVRAJKAMBLE-11OCT2022
                                        if ($ClosingBarcodeTallyQTYOp == 0 || $ClosingBarcodeTallyQTYOp < 0) {
                                            echo '-';
                                        } else {
                                            echo $ClosingBarcodeTallyQTYOp;
                                        }
                                        ?>
                                    </div>
                                </td>
            ...
            //
            // End Code To Fetch All Records - Group By multi_barcode_product_category @AUTHOR:YUVRAJKAMBLE-11OCT2022 
            //
            ?>
            ...
            //
            $dropTempOpBookStock = "DROP table TEMP_BARCODE_OPENING_BOOK_STOCK";
            mysqli_query($conn, $dropTempOpBookStock) or die('<br/> ERROR:' . mysqli_error($conn));
            // DROP TEMP_BARCODE_OPENING_STOCK TABLE @AUTHOR:YUVRAJKAMBLE-07DEC2022
            $dropTempOpStock = "DROP table TEMP_BARCODE_OPENING_STOCK";
            mysqli_query($conn, $dropTempOpStock) or die('<br/> ERROR:' . mysqli_error($conn));
            //
            //
            // DROP TEMP_BARCODE_OPENING_OUTWARD_STOCK TABLE @AUTHOR:YUVRAJKAMBLE-07DEC2022
            $dropTempOpeningOutStock = "DROP table TEMP_BARCODE_OPENING_OUTWARD_STOCK";
            mysqli_query($conn, $dropTempOpeningOutStock) or die('<br/> ERROR:' . mysqli_error($conn));
            //
            //
            // DROP TEMP_BARCODE_TODAY_OUTWARD_STOCK TABLE @AUTHOR:YUVRAJKAMBLE-07DEC2022
            $dropTempTodayOutStock = "DROP table TEMP_BARCODE_TODAY_OUTWARD_STOCK";
            mysqli_query($conn, $dropTempTodayOutStock) or die('<br/> ERROR:' . mysqli_error($conn));
            //
            //
            // DROP TEMP_BARCODE_INWARD_STOCK TABLE @AUTHOR:YUVRAJKAMBLE-07DEC2022
            $dropTempInStock = "DROP table TEMP_BARCODE_INWARD_STOCK";
            ...
            //
            //
            $dropClosingStockBook = "DROP table TEMP_BARCODE_CLOSING_STOCK";
