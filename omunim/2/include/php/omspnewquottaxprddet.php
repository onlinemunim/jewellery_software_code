 ...
 *
 * @FileName: omspnewquottaxprddet.php
    ...
    <td>
        <table style="width:96%;margin:auto" class="billing-table">
            ...
            if ($invName == 'metalPurchase') {
                ...
                $qSelSlPrItemDetails = "SELECT sttr_id,sttr_image_id,sttr_firm_id,sttr_item_pre_id,sttr_item_id,sttr_metal_type,sttr_item_name,sttr_quantity,sttr_gs_weight,sttr_gs_weight_type,sttr_pkt_weight_type,sttr_nt_weight_type,sttr_pkt_weight,sttr_nt_weight,sttr_final_fine_weight,sttr_metal_rate,sttr_sell_rate,sttr_metal_discount_amt,sttr_mkg_discount_amt,sttr_metal_discount_per,sttr_mkg_discount_per,sttr_stone_discount_amt,sttr_stone_discount_per,sttr_indicator,sttr_purity,sttr_final_purity,sttr_wastage,sttr_cust_wastage,sttr_valuation,sttr_fixed_price_status,sttr_cust_price,sttr_final_valuation,sttr_making_charges,sttr_stone_valuation,sttr_total_making_amt,sttr_metal_amt,sttr_stone_amt,sttr_making_charges_type,sttr_final_purity,sttr_value_added,sttr_final_valuation_by,sttr_total_lab_charges,sttr_lab_charges_type,sttr_hsn_no,sttr_item_code,sttr_transaction_type,sttr_hallmark_uid,sttr_cust_price,sttr_color,sttr_clarity,sttr_other_info,sttr_size,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_cust_wastage,sttr_cust_wastage_wt,sttr_other_charges,sttr_tot_tax,sttr_product_purchase_rate,sttr_product_sell_rate,sttr_barcode_prefix,sttr_barcode,sttr_mkg_cgst_per,sttr_mkg_cgst_chrg,sttr_mkg_sgst_per,sttr_mkg_sgst_chrg,sttr_mkg_igst_per,sttr_mkg_igst_chrg,sttr_tot_price_cgst_per,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_per,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_per,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_making_charges_type,sttr_total_cust_price,sttr_item_other_info,sttr_other_charges_type,sttr_tax,sttr_fine_weight,sttr_mkg_charges_by,sttr_hallmark_charges FROM stock_transaction where sttr_owner_id = '$sessionOwnerId' "
                ...
                $qSelSlPrItemDetails = "SELECT sttr_id,sttr_sttr_id,sttr_image_id,sttr_firm_id,sttr_item_pre_id,sttr_item_id,sttr_metal_type,sttr_item_name,sttr_quantity,sttr_gs_weight,sttr_gs_weight_type,sttr_pkt_weight_type,sttr_nt_weight_type,sttr_pkt_weight,sttr_nt_weight,sttr_final_fine_weight,sttr_metal_rate,sttr_sell_rate,sttr_metal_discount_amt,sttr_mkg_discount_amt,sttr_metal_discount_per,sttr_mkg_discount_per,sttr_stone_discount_amt,sttr_stone_discount_per,sttr_indicator,sttr_purity,sttr_final_purity,sttr_wastage,sttr_cust_wastage,sttr_valuation,sttr_fixed_price_status,sttr_cust_price,sttr_final_valuation,sttr_making_charges,sttr_stone_valuation,sttr_total_making_amt,sttr_metal_amt,sttr_stone_amt,sttr_making_charges_type,sttr_final_purity,sttr_value_added,sttr_final_valuation_by,sttr_total_lab_charges,sttr_lab_charges_type,sttr_hsn_no,sttr_item_code,sttr_transaction_type,sttr_hallmark_uid,sttr_cust_price,sttr_color,sttr_clarity,sttr_other_info,sttr_size,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_cust_wastage,sttr_cust_wastage_wt,sttr_other_charges,sttr_tot_tax,sttr_product_purchase_rate,sttr_product_sell_rate,sttr_barcode_prefix,sttr_barcode,sttr_mkg_cgst_per,sttr_mkg_cgst_chrg,sttr_mkg_sgst_per,sttr_mkg_sgst_chrg,sttr_mkg_igst_per,sttr_mkg_igst_chrg,sttr_tot_price_cgst_per,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_per,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_per,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_making_charges_type,sttr_total_cust_price,sttr_item_other_info,sttr_other_charges_type,sttr_tax,sttr_fine_weight,sttr_mkg_charges_by,sttr_hallmark_charges FROM stock_transaction where sttr_owner_id='$sessionOwnerId' "
                        . "and sttr_pre_invoice_no='$slPrPreInvoiceNo' and sttr_invoice_no='$slPrInvoiceNo' "
...
//
//echo 'utin_transaction_type == ' . $utin_transaction_type . '</b>';
//
...
//
            if ($invName == 'metalPurchase') {
                ...
                $qSelSlPrItemDetails = "SELECT sttr_id,sttr_image_id,sttr_firm_id,sttr_item_pre_id,sttr_item_id,sttr_metal_type,sttr_item_name,sttr_quantity,sttr_gs_weight,sttr_gs_weight_type,sttr_pkt_weight_type,sttr_nt_weight_type,sttr_pkt_weight,sttr_nt_weight,sttr_final_fine_weight,sttr_metal_rate,sttr_sell_rate,sttr_metal_discount_amt,sttr_mkg_discount_amt,sttr_metal_discount_per,sttr_mkg_discount_per,sttr_stone_discount_amt,sttr_stone_discount_per,sttr_indicator,sttr_purity,sttr_final_purity,sttr_wastage,sttr_cust_wastage,sttr_valuation,sttr_fixed_price_status,sttr_cust_price,sttr_final_valuation,sttr_making_charges,sttr_stone_valuation,sttr_total_making_amt,sttr_metal_amt,sttr_stone_amt,sttr_making_charges_type,sttr_final_purity,sttr_value_added,sttr_final_valuation_by,sttr_total_lab_charges,sttr_lab_charges_type,sttr_hsn_no,sttr_item_code,sttr_transaction_type,sttr_hallmark_uid,sttr_cust_price,sttr_color,sttr_clarity,sttr_other_info,sttr_size,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_cust_wastage,sttr_cust_wastage_wt,sttr_other_charges,sttr_tot_tax,sttr_product_purchase_rate,sttr_product_sell_rate,sttr_barcode_prefix,sttr_barcode,sttr_mkg_cgst_per,sttr_mkg_cgst_chrg,sttr_mkg_sgst_per,sttr_mkg_sgst_chrg,sttr_mkg_igst_per,sttr_mkg_igst_chrg,sttr_tot_price_cgst_per,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_per,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_per,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_making_charges_type,sttr_total_cust_price,sttr_item_other_info,sttr_other_charges_type,sttr_tax,sttr_fine_weight,sttr_mkg_charges_by,sttr_hallmark_charges,sttr_total_hallmark_charges,sttr_purchase_rate FROM stock_transaction where sttr_owner_id = '$sessionOwnerId' "
                        . "and sttr_pre_invoice_no = '$slPrPreInvoiceNo' and sttr_invoice_no = '$slPrInvoiceNo' "
                ...
                $qSelSlPrItemDetails = "SELECT sttr_id,sttr_image_id,sttr_firm_id,sttr_item_pre_id,sttr_item_id,sttr_metal_type,sttr_item_name,sttr_item_category,sttr_quantity,sttr_gs_weight,sttr_gs_weight_type,sttr_pkt_weight_type,sttr_nt_weight_type,sttr_pkt_weight,sttr_nt_weight,sttr_final_fine_weight,sttr_metal_rate,sttr_sell_rate,sttr_metal_discount_amt,sttr_mkg_discount_amt,sttr_metal_discount_per,sttr_mkg_discount_per,sttr_stone_discount_amt,sttr_stone_discount_per,sttr_indicator,sttr_purity,sttr_final_purity,sttr_wastage,sttr_cust_wastage,sttr_valuation,sttr_fixed_price_status,sttr_cust_price,sttr_final_valuation,sttr_making_charges,sttr_stone_valuation,sttr_total_making_amt,sttr_metal_amt,sttr_stone_amt,sttr_making_charges_type,sttr_final_purity,sttr_value_added,sttr_final_valuation_by,sttr_total_lab_charges,sttr_lab_charges_type,sttr_hsn_no,sttr_item_code,sttr_transaction_type,sttr_hallmark_uid,sttr_cust_price,sttr_color,sttr_clarity,sttr_size,sttr_certificate_no,sttr_shape,sttr_other_info,sttr_size,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_cust_wastage,sttr_cust_wastage_wt,sttr_other_charges,sttr_tot_tax,sttr_product_purchase_rate,sttr_product_sell_rate,sttr_barcode_prefix,sttr_barcode,sttr_mkg_cgst_per,sttr_mkg_cgst_chrg,sttr_mkg_sgst_per,sttr_mkg_sgst_chrg,sttr_mkg_igst_per,sttr_mkg_igst_chrg,sttr_tot_price_cgst_per,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_per,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_per,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_making_charges_type,sttr_total_cust_price,sttr_item_other_info,sttr_other_charges_type,sttr_tax,sttr_fine_weight,sttr_mkg_charges_by,sttr_hallmark_charges,sttr_total_hallmark_charges FROM stock_transaction where sttr_owner_id='$sessionOwnerId' "
                        . "and sttr_pre_invoice_no='$slPrPreInvoiceNo' and sttr_invoice_no='$slPrInvoiceNo' "
...
//                                           $ntWtType = $rowSlPrItemDetails['sttr_nt_weight_type'];
                ...
                $totalSlPrCryValuation += $slPrCryValuation;
                ...
                //
                $totalSlPrMkgChrg += $sttr_total_making_charges;
...
//                        }
                ...
                //
                if ($slPrindicator != 'stockCrystal') {
                    $qSelCrystalDet = "SELECT sttr_id,sttr_image_id,sttr_firm_id,sttr_item_pre_id,sttr_item_id,sttr_metal_type,sttr_item_name,sttr_quantity,sttr_gs_weight,sttr_gs_weight_type,sttr_pkt_weight_type,sttr_nt_weight_type,sttr_pkt_weight,sttr_nt_weight,sttr_final_fine_weight,sttr_metal_rate,sttr_sell_rate,sttr_metal_discount_amt,sttr_mkg_discount_amt,sttr_metal_discount_per,sttr_mkg_discount_per,sttr_stone_discount_amt,sttr_stone_discount_per,sttr_indicator,sttr_purity,sttr_final_purity,sttr_wastage,sttr_cust_wastage,sttr_valuation,sttr_fixed_price_status,sttr_cust_price,sttr_final_valuation,sttr_making_charges,sttr_stone_valuation,sttr_total_making_amt,sttr_metal_amt,sttr_stone_amt,sttr_making_charges_type,sttr_final_purity,sttr_value_added,sttr_final_valuation_by,sttr_total_lab_charges,sttr_lab_charges_type,sttr_hsn_no,sttr_item_code,sttr_transaction_type,sttr_hallmark_uid,sttr_cust_price,sttr_color,sttr_clarity,sttr_other_info,sttr_size,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_cust_wastage,sttr_cust_wastage_wt,sttr_other_charges,sttr_tot_tax,sttr_product_purchase_rate,sttr_product_sell_rate,sttr_barcode_prefix,sttr_barcode,sttr_mkg_cgst_per,sttr_mkg_cgst_chrg,sttr_mkg_sgst_per,sttr_mkg_sgst_chrg,sttr_mkg_igst_per,sttr_mkg_igst_chrg,sttr_tot_price_cgst_per,sttr_tot_price_cgst_chrg,sttr_tot_price_sgst_per,sttr_tot_price_sgst_chrg,sttr_tot_price_igst_per,sttr_tot_price_igst_chrg,sttr_total_making_charges,sttr_making_charges,sttr_making_charges_type,sttr_total_cust_price,sttr_item_other_info,sttr_other_charges_type,sttr_tax,sttr_fine_weight,sttr_mkg_charges_by FROM stock_transaction WHERE sttr_owner_id = '$sessionOwnerId' "
...
//                $mainTotalGstAmt += $totalGstAmt;
                include 'omspnewquottaxtblright.php';
...
//            parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            $stSize = $stSize_check;
            $stShape = $stShape_check;
            $stCertificatiNo = $certificateno_check;
//mkgAfterDisGm
...
//                                 
                    ...
                    <!--</td>-->
                    <?php //}   ?>
                    <?php if ($itemSize_check == 'true' && $sizePresent == 'yes') { ?>
                        <td align="center" class="paddingRight5">
...
//                        echo 'hi 2';
                    ...
                    if ($stSize == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
//                        echo 'hi 2';
                        ?>
                        <td align="center" class="paddingRight5">
                    ...
                    if ($stShape == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
//                        echo 'hi 2';
                        ?>
                        <td align="center" class="paddingRight5">
                    ...
                    if ($stCertificatiNo == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
//                        echo 'hi 2';
                        ?>
                        <td align="center" class="paddingRight5">
                    ...
                    if ($itemFinalAmt == 'true' && ($paymentMode != 'NoRateCut' || $crystalPresent == 'yes')) {
                        ...
                        <td align="left" class="" style ="padding-right: 6px !important;font-size:<?php echo $label_field_font_size; ?>px;color:<?php echo $label_field_font_color; ?>; text-align:left;">
                            ...
                            if ($sttrFixedPriceStatus == 'TRUE') {
                                //
                                echo number_format($sttr_cust_price, 2);
                                //
                            } else {
...
//                                    . "label_field_name = '$fieldName' and label_type = '$labelType'"));
                    ...
                    if ($itemGsWt == 'true') {
                        ...
                        <td align="right" valign="top" style="text-align: right; padding-right: 6px !important;">
                            ...
                            <?php echo number_format($silverTotGsWt, 3) . ' ' . $iWtType; ?>
                        </td>
                    <?php } ?>
...
//                    parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                    ...
                    if ($itemFinalAmt == 'true' && ($paymentMode != 'NoRateCut' || $crystalPresent == 'yes')) {
                        ?>
                        <td align="right" class="" style ="padding-right: 6px !important;font-size:<?php echo $label_field_font_size; ?>px;color:<?php echo $label_field_font_color; ?>; text-align:right;">
                            <?php
...
$sample4InvTaxDetails = $rowsample4InvTaxDetails['omly_value'];
//
// ********************************************************************************
                            ...
                            <?php if ($totalAmt != 0) { ?>
                                <tr>
                                    ...
                                    <td align="left" class="border-color-grey-bottom border-color-grey-top">
                                        <?php
                                        echo "$globalCurrency" . ' ' . ucwords(numToWords((abs($totalAmt)))) . ' Only/-';
                                        ?>
                                    </td>
                                    <?php
                                }
...
//                parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                                ...
                                <td>
                                    <?php echo "$globalCurrency" . ' ' . ucwords(numToWords(abs($totalReceivableamt + 0))) . ' Only/-'; ?>
                                </td>
                            </tr>
                        <?php } ?>
                        <?php
...
<tr>
    <td>
        <div>
            <h3 style="margin:0;color:#ec9000;font-size:18px">Thank You for business with us</h4>
        </div>
    </td> 
</tr>
<tr>
...
//        parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
        if ($footer_ad_img_check == 'true') {
            ?>
            <?php parse_str(getTableValues("SELECT image_id,image_user_id,image_user_type FROM image WHERE image_snap_desc = 'SellPurchaseInvAds'")); ?>
            <?php if ($image_id != '') { ?>
