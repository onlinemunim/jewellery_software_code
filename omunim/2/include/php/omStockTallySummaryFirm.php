...
/*
 * **************************************************************************************************
 * @Description: RFID TALLY REPORT  PANEL - FIRM FILE @Author-YUVRAJ -17112022
 * **************************************************************************************************
 *
 * Created on OCT 18, 2021 08:12:58 PM 
 * **************************************************************************************
 * @FileName: C:\Project\OMUNIM_2.7.68_SVN_COMP_SW\htdocs\omunim\2\include\php\omStockTallySummaryFirm.php
...
?>
<?php 
// Start Code for Firm  @Author-YUVRAJ -17112022 
?>
<SELECT class="form-control-select-borderless" 
        ...
        onchange="searchStockTallySummaryReportDetails(document.getElementById('FirmName').value, '<?php echo $panelName; ?>',
...
<?php 
// End Code for Firm  @Author-YUVRAJ -17112022 
?>