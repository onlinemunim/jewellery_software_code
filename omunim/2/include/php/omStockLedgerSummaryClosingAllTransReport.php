...
/*
 * *************************************************************************************************
 * @tutorial: STOCK LEDGER SUMMARY CLOSING ALL TRANSACTIONS REPORT @AUTHOR:PRIYANKA-11JAN2022
 * *************************************************************************************************
 * 
 * Created on JAN 11, 2022 12:30:08 PM
 *
 * @FileName: omStockLedgerSummaryClosingAllTransReport.php
 ...
 * @ModificaionHistory
 *  MODIFICATION DATE:
 *  AUTHOR: @AUTHOR:PRIYANKA-11JAN2022
 *  REASON:
 *
 */
?>
...
if ($todayFromStrDate == $todayToStrDate) {
    //
    $dateRangeStrForClosing = "UNIX_TIMESTAMP(STR_TO_DATE(st.sttr_add_date,'%d %b %Y')) BETWEEN $todayFromStrDate AND $todayToStrDate ";
    //
    $dateStrForClosing = "UNIX_TIMESTAMP(STR_TO_DATE(st.sttr_add_date,'%d %b %Y'))<=$todayFromStrDate ";
    //
} else {
    //
    $dateRangeStrForClosing = "UNIX_TIMESTAMP(STR_TO_DATE(st.sttr_add_date,'%d %b %Y')) BETWEEN $todayFromStrDate AND $todayToStrDate ";
        ...
        <div class="card-body">
            <div style="border-radius: 5px !important;">
                <div class="card-header" 
                    ...
                    <table width="100%">
                        <tr id="headerTable">
                            <td align="left" width="50%">CLOSING STOCK TRANSACTIONS</td>
                ...
                <div class='card-body'>
                    ...
                    if ($selFirmId != NULL) {
                        ...
                        $strFrmId = '0';
                        //
                        // Set String for Public Firms @AUTHOR:PRIYANKA-11JAN2022
                    ...
                    <div id="purchaseDetailsSubDiv">
                        ...
                        //
                        //
                        $dateStrForCl = "UNIX_TIMESTAMP(STR_TO_DATE(st.sttr_add_date,'%d %b %Y'))<=$todayToStrDate";
                        //
                        //
                        // Table Where @AUTHOR:PRIYANKA-17JAN2022
                        $whereStr = " stock.sttr_id NOT IN "
                                . "(SELECT IF(sttr.sttr_sttr_id IS NULL,sttr.sttr_id,sttr.sttr_sttr_id) FROM temp_view as sttr "
                                . " WHERE (sttr.sttr_transaction_type IN ('sell', 'ESTIMATESELL', 'APPROVAL', 'PurchaseReturn') OR ((sttr.sttr_melting_status IN ('Y','RFM','AFM','N') OR sttr.sttr_melting_status IS NOT NULL) AND sttr_melting_status!='')) "
                                . " AND sttr.sttr_status IN ('PaymentDone', 'PaymentPending', 'ApprovalDone','TAG','EXISTING') "
                                //. " AND sttr.sttr_indicator IN ('stock', 'imitation', 'RetailStock', 'crystal', 'strsilver', 'rawMetal', 'APPROVAL') "
                                . " AND sttr.sttr_indicator IN ('stock','RetailStock','APPROVAL') "
                                . " AND ((UNIX_TIMESTAMP(STR_TO_DATE(sttr.sttr_add_date,'%d %b %Y'))<=$todayToStrDate) OR (UNIX_TIMESTAMP(STR_TO_DATE(sttr.sttr_melting_date,'%d %b %Y'))<=$todayToStrDate)) "
                                ...
                                . " AND stock.sttr_indicator IN ('stock', 'AddInvoice','RetailStock','ItemReturn') "
                        ...
                        //
                        //
                        // Table Joins @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        $createView = "CREATE table temp_view AS "
                                ...
                                . "st.sttr_final_gs_weight as 'sttr_final_gs_weight',"
                                //
                        ...
                        //
                        //
                        // Data Table Main Columns @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        //
                        //
                        // Table Parameters @AUTHOR:PRIYANKA-11JAN2022
                        $_SESSION['tableName'] = 'temp_view as stock'; // Table Name
                        $_SESSION['tableNamePK'] = 'stock.sttr_id'; // Primary Key
                        //
                        //
                        //
                        // DB Table Columns Parameters @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        //
                        //
                        $_SESSION['dbColumnsArray'] = $dbColumnsArray;  // No Change @AUTHOR:PRIYANKA-11JAN2022
                        //
                        //
                        ...
                        //
                        //
                        // Extra direct columns we need pass in SQL Query @AUTHOR:PRIYANKA-11JAN2022
...
//                            }
                        //
                        //
                        // On Click Function Parameters @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        //
                        //
                        // Delete Function Parameters @AUTHOR:PRIYANKA-11JAN2022
                        $_SESSION['deleteColumn'] = ""; // On which column @AUTHOR:PRIYANKA-11JAN2022
                        $_SESSION['deleteColumnId'] = "";
                        $_SESSION['deleteColumnValue'] = "";
                        $_SESSION['deleteColumnFunction'] = "";
                        $_SESSION['deleteColumnFunctionPara1'] = ""; // Panel Name @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        //
                        //
                        // Where Clause Condition @AUTHOR:PRIYANKA-11JAN2022
                        ...
                        //
                        //
                        // Data Table Main File @AUTHOR:PRIYANKA-11JAN2022
