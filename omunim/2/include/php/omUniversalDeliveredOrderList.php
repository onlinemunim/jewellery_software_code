 ...
 *
 * @FileName: omUniversalDelivedOrderList.php
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td valign="middle" align="left" width="50%">
                <div class="main_link_orange16" style="color:#22950C !important;">DELIVERED ORDER LIST<span class="textLabel14CalibriGreyMiddle">
...
$_SESSION['onclickColumnFunctionPara3'] = "newOrderDeliveredList";
...
$_SESSION['onclickColumnTwo'] = ""; // On which column
$_SESSION['onclickColumnIdTwo'] = "";
$_SESSION['onclickColumnValueTwo'] = "";
$_SESSION['onclickColumnFunctionTwo'] = "";
$_SESSION['onclickColumnFunctionTwoPara1'] = "";
$_SESSION['onclickColumnFunctionTwoPara2'] = "";
$_SESSION['onclickColumnFunctionTwoPara3'] = "";
...
$_SESSION['tableWhere'] = "sttr_owner_id = '$_SESSION[sessionOwnerId]' AND sttr_firm_id IN ($strFrmId) "
                        ...
                        . "AND sttr_delivery_status IN ('DELIVERED') "
