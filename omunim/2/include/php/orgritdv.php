                            ...
                            <tr align="left">
                                ...
                                <td align="left" class="frm-r1" valign="middle">
                                    <h5>
                                        ...
                                        $rowAllGirviItemTunch = mysqli_fetch_array($resGirviItemTunch, MYSQLI_ASSOC);

                                        echo $rowAllGirviItemTunch['itm_tunch_name'];
                                        ?>
                                    </h5>
                                </td>
                            </tr>
...
$girviItemTunchMetal = $rowAllGirviItemTunch['itm_tunch_metal_type'];
$girviItemTunchValue = $rowAllGirviItemTunch['itm_tunch_value'];
