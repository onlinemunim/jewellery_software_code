...
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            if($itemCounter_check == 'true'){
                 $totalColumns++;
//            $fieldName = 'itemDescLb';
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ?>
                <th align="left" style="font-size: <?php echo $itemCounterLb_size; ?>px;"><?php echo $itemCounterLb_content; ?></th>
                <?php
            }
//        $fieldName = 'brandName';
//        $label_field_check = '';
...
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            if($itemWstgWt_check == 'true'){ 
                 $totalColumns++; ?>
                <th align="center" style="font-size: <?php echo $itemWstgWtLb_size; ?>px;"><?php echo $itemWstgWtLb_content; ?></th> 
                <?php
            }
//        $fieldName = 'itemWSWt';
//        $label_field_check = '';
...
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            if ($itemFnWt_check == 'true') {
                $totalColumns++;
//            $fieldName = 'itemFfnWtLb';
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ?>
                <th align="center" style="font-size: <?php echo $itemFnWtLb_size; ?>px;"><?php echo $itemFnWtLb_content; ?></th> 
                <?php
            }
...
//                    parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ...
                //   START DIA WT ,ST WT @DNYANESHWARI 27AUG2023
                $fieldName = 'diaWt';
//                $label_field_check = '';
//                parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                 $label_field_check = $getLabelDetails[strtolower($fieldName)]['label_field_check'];
               if ($label_field_check == 'true' && $crystalPresent == 'yes') {
                    $totalColumns++;
                    $fieldName = 'diaWtLb';
//                    parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                    $label_field_font_size = $getLabelDetails[strtolower($fieldName)]['label_field_font_size'];
...
//                    parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ...
                // END DIA WT ,ST WT @DNYANESHWARI 27AUG2023
...
<!--                    <th></th>
                    <th></th>-->
                    <th align="left" style="font-size: <?php echo $amtLb_size; ?>px;"><?php echo $amtLb_content; ?></th>  
                    <?php
                }else if ($amt_check == 'true' && ($paymentMode == 'NoRateCut' || $crystalPresent == 'yes')) {
                    $totalColumns++; ?>
                    <th align="left" style="font-size: <?php echo $amtLb_size; ?>px;"><?php echo $amtLb_content; ?></th>  
                    <?php
                }
...
<tbody class="table-innerSec">
    ...
    <?php
    $counter = 2; {
        if(($hideStoneDetails == 'YES' && $slPrindicator != 'stockCrystal') || ($hideStoneDetails == 'NO' || $hideStoneDetails == '' || $hideStoneDetails == NULL)){
        ?>
        <tr>
            <?php
//            $fieldName = 'sNo';
...
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            if ($design_check == 'true' && $designpresent == 'yes') {
                ...
                <td align="center" style="padding-bottom: unset; padding-top: 1px;">
                    ...
                    //
                    //parse_str(getTableValues("SELECT sttr_image_id FROM stock_transaction_sell_2022_2023 WHERE sttr_item_code='$slPrItmCode' and sttr_transaction_type!='sell'"));
...
//                            parse_str(getTableValues("SELECT label_field_content FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
        ...
        echo $slPrItemCategory;
            ...
            <?php
             if ($itemCounter_check == 'true') {
                ?>
                <td align="center" style="font-size: <?php echo $itemCounter_size; ?>px; "><?php
        echo $sttr_counter_name;
                ?>  <?php }?>
            </td>
            <?php
//            $fieldName = 'brandName';
...
//                parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                if ($itemWstgWt_check == 'true') {
                    ?>
                    <td align="center" style="font-size: <?php echo $itemWstgWt_size; ?>px;">
                        <?php
                        if ($slcustwastagewt != 0) {
                            echo $slcustwastagewt;
                        } else {
                            echo" ";
                        }
                        ?>
...
//                            . " label_field_name = '$fieldName' and label_type = '$labelType'"));
            if ($itemFnWt_check == 'true') {
                ?>
                <td align="center" style="font-size: <?php echo $itemFnWt_size; ?>px;">
                    <?php
                    //
                    if ($rowSlPrItemDetails['sttr_fine_weight'] > 0) {
                        echo $slprFnWt;
                    } else {
                        echo ' ';
                    }
                ...
                if ($mkg_chrg_val_check == 'true') {
                    ...
                    if ($sttr_total_making_charges != 0 || $sttr_total_making_charges == NULL || $sttr_total_making_charges == '') {
                        ...
                        <td align="center" style="font-size: <?php echo $mkg_chrg_val_size; ?>px;">
                            <?php echo ($sttr_total_making_charges - $totalOtherCharges); // Code for Other Charges @Author:PRIYANKA-12OCT2018  ?>
                        </td>
                        <?php
                    } else {
                        ?>
...
//                parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                if ($totalCrystal_check == 'true') {
                    ...
                    <td align="center" style="font-size: <?php echo $totalCrystal_size; ?>px;">
                        <?php
                        if($slPrItemCategory == 'Diamond' || $slPrItemCategory == 'diamond'){
                                            echo '';
                                        }else if($slPrindicator == 'stockCrystal'){
                                           echo formatInIndianStyle($sttr_valuation);   
                                        } else if($slPrindicator == 'stock'){
                                        echo '';
                                     }
                        ?>
                    </td>
...
//                            echo $slPrItemFinVal - $stone_valuation + $slPrCryValuation; // for crystal amt valuation Author:DIKSHA 05April2019
                            echo formatInIndianStyle($sttr_valuation);
                        }
                     }} else {
                        echo " ";
...
//            parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
           //
            ...
            if ($diaWt_check == 'true' && $crystalPresent == 'yes') {
                ...
                <td align="right" style="font-size: <?php echo $itemFixedMrpPrice_size; ?>px;"> 
                    <?php
                    if(strpos($slPrItemCategory, 'DIAMOND') !== false || strpos($slPrItemCategory, 'Diamond') !== false || strpos($slPrItemCategory, 'diamond') !== false ||
                           strpos($slPrItemCategory, 'DIA') !== false || strpos($slPrItemCategory, 'Dia') !== false || strpos($slPrItemCategory, 'dia') !== false  
                            ){
                        echo decimalVal($slPrItemGSW, 3) . " " . $gsWtType;
                    }else{
                            echo '-';
            ...
            if ($label_field_check == 'true' && $crystalPresent == 'yes') {
                ...
                <td align="right" style="font-size: <?php echo $itemFixedMrpPrice_size; ?>px;"> 
                    <?php
                    if((strpos($slPrItemCategory, 'DIAMOND') === false && strpos($slPrItemCategory, 'Diamond') === false && strpos($slPrItemCategory, 'diamond') === false &&
                          strpos($slPrItemCategory, 'DIA') === false && strpos($slPrItemCategory, 'Dia') === false && strpos($slPrItemCategory, 'dia') === false  ) && $sttrIndicator == 'stockCrystal'){
                        echo decimalVal($slPrItemGSW, 3) . " " . $gsWtType;
                    }else{
                            echo '-';
                       } 
...
<!--                <td style="border:none;"></td>
                <td style="border:none;"></td>-->
                    <td align="center" style="padding-right: unset; font-size: <?php echo $amt_size; ?>px;">
                        <table border="0" valign="top" cellspacing="0" cellpadding="0" align="left">
                            <?php ?>
                            <tr> 
                                <td align="left"  style=" font-size: <?php echo $amt_size; ?>px;">
                                    <?php
...
//                                        while ($rowCrystalVal = mysqli_fetch_array($resCrystalVal, MYSQLI_ASSOC)) {
            ...
            }else if ($paymentMode == 'NoRateCut' || $crystalPresent == 'yes') {
//                $fieldName = 'amt';
//                $label_field_check = '';
//                parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                if ($amt_check == 'true' && ($paymentMode == 'NoRateCut' || $crystalPresent == 'yes')) {
