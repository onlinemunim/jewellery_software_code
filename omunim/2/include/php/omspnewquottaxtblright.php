...
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size, label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            //START CODE FOR STONE SHAPE , SIZE AND CERTIFICATION NO  @AUTHOR DNYANESHWARI-19AUG2024
            //        $fieldName = 'stSize';
//        $label_field_check = '';
//        parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));

            if ($stSize_check == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
                $totalColumns++;
//            $fieldName = 'stSizeLb';
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size, label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ?>
                <th align="left" style="padding-left: 5px; font-size: <?php echo $stSizeLb_size; ?>px;"><?php echo $stSizeLb_content; ?></th>
                <?php
            }
            //        $fieldName = 'stShape';
//        $label_field_check = '';
//        parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            if ($stShape_check == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
                $totalColumns++;
//            $fieldName = 'stShapeLb';
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size, label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ?>
                <th align="left" style="padding-left: 5px; font-size: <?php echo $stShapeLb_size; ?>px;"><?php echo $stShapeLb_content; ?></th>
                <?php
            }
...
//        parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
            ...
            if ($certificateno_check == 'true' && ($noOfCry > 0 || $crystalPresent == 'yes')) {
                $totalColumns++;
//            $fieldName = 'certificatenoLb';
//            parse_str(getTableValues("SELECT label_field_content,label_field_font_size, label_field_font_color FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ?>
                <th align="left" style="padding-left: 5px; font-size: <?php echo $stClarityLb_size; ?>px;"><?php echo $certificatenoLb_content; ?></th>
                <?php
            }
            //END CODE FOR STONE SHAPE , SIZE AND CERTIFICATION NO  @AUTHOR DNYANESHWARI-19AUG2024
//            $fieldName = 'TotalVa';
//            $label_field_check = '';
//            parse_str(getTableValues("SELECT label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ...
                <td align="center" style="padding-bottom: unset; padding-top: 1px;">
                    ...
                    if ($invName == 'metalPurchase' || $invName == 'rawMetalSale') {
                        ...
                        if ($slPrId != '' && $slPrId != NULL) {
                            ...
                            $selectImgId = "SELECT * FROM stock_transaction WHERE sttr_id='$slPrId'";
                            //
...
//                parse_str(getTableValues("SELECT label_field_content,label_field_font_size,label_field_font_color,label_field_check FROM labels WHERE label_own_id = '$sessionOwnerId' and label_field_name = '$fieldName' and label_type = '$labelType'"));
                ...
                $silverHalIndicator = $rowSlHal['omly_value'];
                if ($hallmarkingCharges_check == 'true') {
                    ?>
...
//                    echo 'hh  11';
                    ?>
                    <td align="center" style="font-size: <?php echo $stSize_size; ?>px;">
                        <?php
                        if ($sttrIndicator == 'stockCrystal') {
                            echo $rowSlPrItemDetails['sttr_size'];
                        } else {
                            echo '-';
                        }
                        ?>
...
//                    echo 'hh  11';
                    ?>
                    <td align="center" style="font-size: <?php echo $stShape_size; ?>px;">
                        <?php
                        if ($sttrIndicator == 'stockCrystal') {
                            echo $rowSlPrItemDetails['sttr_shape'];
                        } else {
                            echo '-';
                        }
                        ?>
...
//                    echo 'hh  11';
                    ?>
                    <td align="center" style="font-size: <?php echo $certificateno_size; ?>px;">
                        <?php
                        if ($sttrIndicator == 'stockCrystal') {
                            echo $rowSlPrItemDetails['sttr_certificate_no'];
                        } else {
                            echo '-';
                        }
                        ?>
                ...
                if ($totalCrystal_check == 'true') {
                    ...
                    <td align="center" style="font-size: <?php echo $totalCrystal_size; ?>px;">
                        ...
                        if ($slPrItemCategory == 'Diamond' || $slPrItemCategory == 'diamond') {
                            ...
                            $CrystalVal = $slPrItemGSW * $slPrPurchaseRate;
                            echo $CrystalVal;
