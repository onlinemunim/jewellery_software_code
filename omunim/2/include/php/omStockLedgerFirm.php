...
/*
 * **************************************************************************************************
 * @Description: STOCK LEDGER PANEL - FIRM FILE @Author-PRIYANKA-25OCT2021
 * **************************************************************************************************
 *
 * Created on OCT 25, 2021 06:12:58 PM 
 * **************************************************************************************
 * @FileName: omStockLedgerFirm.php
...
<SELECT class="form-control-select-borderless" 
        ...
        onchange="searchStockLedgerDetails(document.getElementById('FirmName').value, '<?php echo $panelName; ?>',
