...
/*
 * **************************************************************************************
 * @tutorial: UDHAAR MONEY DEPOSIT CUSTOMISATION @SIMRAN@15SEPT2023
 * **************************************************************************************
 * 
 *
 * @FileName: omUdhaarfmad.php
...
<div class="posAbsolute" style="left:40%;margin-top:<?php echo $divTopMargin; ?>px;">
    ...
    <form name="add_stock" id="add_stock"
          ...
          action="include/php/omUdhaarInvfoad.php"   
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="left" valign="middle" style="border: #c1c1c1 1px solid; height: 35px;padding:5px 3px;" class="backF9F9F9 textBoxCurve1px">
            ...
            <?php
            if ($display == 'YES' && $divId != 'tncUdhaarInvDiv') {
                if ($divId != 'authUhaarInvCustSignLbDiv' && $divId != 'authUhaarInvCustSignLbDiv' && $divId != 'udhaarInvTitleDiv' && $divId != 'footerUdhaarInvLbDiv') {
                    ?>
            ...
            <?php } else if ($divId == 'tncUdhaarInvDiv') { ?>
            ...
            <?php } else { ?>
                ...
                <?php
            }if ($fieldName != 'firmLeftLogoCheck' && $fieldName != 'firmRightLogoCheck') {
                ...
                <?php }if ($fieldName != 'firmLeftLogoCheck' && $fieldName != 'firmRightLogoCheck') { ?>
                ...
                <?php } if (($fieldName == 'firmLeftLogoCheck' || $fieldName == 'firmRightLogoCheck')) { 
                     if ($_SESSION['sessionProdName'] == 'OMRETL') {  
                $fontSize = '12'; // add this variable for om retail @YUVRAJ KAMBLE 16012023
                }
                    ?>
                <input id="fieldName" name="fieldName" type="hidden" value="<?php echo $fieldName; ?>"/>
                <input id="fontSize<?php echo $cnt; ?>" name="fontSize<?php echo $cnt; ?>" type="hidden" value="<?php echo $fontSize; ?>"/>
            ...
            if ($display == 'NO' || $divId == 'tncUdhaarInvDiv' || $divId == 'authUdhaarInvSignLbDiv' || $divId == 'authUhaarInvCustSignLbDiv' || $divId == 'couponDisplayLbDiv' || $divId == 'udhaarInvTitleDiv' ||
                    $divId == 'footerUdhaarInvLbDiv' || $divId == 'footerAdImgDiv') {
