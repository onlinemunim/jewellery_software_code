...
/*
 * **************************************************************************************
 * @tutorial: all advance money settled list @OMKAR24JAN2024
 * **************************************************************************************
 * 
 * Created on JAN 24, 202024 18:00:00 
 *
 * @FileName: omsettledreport.php
...
//
//$selNepaliDateIndicator = "SELECT * FROM user_transaction_invoice";
//$resNepaliDateIndicator = mysqli_query($conn, $selNepaliDateIndicator);
//$rowNepaliDateIndicator = mysqli_fetch_array($resNepaliDateIndicator);
//$nepaliDateIndicator = $rowNepaliDateIndicator['omly_value'];
//
...
$utin_settled_date_col = "STR_TO_DATE(u.utin_amt_settled_date,'%d %b %Y')";
?>
    ...
    <div id="advMoneyList">
        <div id="udhharListDiv">
                        ...
                        <table border="0" cellspacing="0" cellpadding="1" width="100%">
                            <tr>
                                <td valign="middle" align="left">
                                    <div class="main_link_orange">ADVANCE MONEY SETTLED REPORT
            ...
            $dataTableColumnsFields = array(
                array('dt' => 'S.No.'),
                array('dt' => 'ADD DATE'),
                array('dt' => 'SETTLED DATE'),
                array('dt' => 'MAIN INV NO'),
                array('dt' => 'USER TYPE'),
                array('dt' => 'CUST. NAME'),
                array('dt' => 'MOB NO.'),
                array('dt' => 'CITY'),
            ...
            $dbColumnsArray = array(
                ...
                "$utin_date_col",
                "$utin_settled_date_col",
                "utin_other_info",
                "t.user_type",
                "CONCAT(t.user_fname, '', t.user_lname)",
                "t.user_mobile",
                "t.user_city",
                "UPPER(u.utin_type)",
            ...
            $_SESSION['tableWhere'] = "u.utin_firm_id IN ($strFrmId)  "
                    . "and u.utin_transaction_type IN ('ADV MONEY','DEPOSIT') "
                    . "and u.utin_amt_pay_chk IN ('checked')"
                    . "and u.utin_status NOT IN ('deleted','Deleted','DELETED','Returned') ";
            // Table Joins
            //
            //
