...
$query = "CREATE TABLE IF NOT EXISTS stock_transaction (
...
sttr_trans_id                                                   VARCHAR(16)," .
        "sttr_transaction_id                                            VARCHAR(10)," . //COLUMN ADDED TO STORE UNIQUE TRANSCATION ID@AUTHOR:MADHUREE-10AUGUST2022
        "sttr_main_entry                                                VARCHAR(2),
sttr_main_entry_count                                           VARCHAR(3),
sttr_sub_entry_count                                            VARCHAR(3),
sttr_panel_name                                                 VARCHAR(64),
sttr_entry_from                                                 VARCHAR(10)," .
...
sttr_sub_staff_id                                               VARCHAR(16)," . // COLUMN ADDED TO BILLING PRICE FOR RETAIL SOFTWARE @AUTHOR:SHRIKANT-10 JAN 2023
...
sttr_rfid_tally_open_report                                     VARCHAR(20), " . // ADD THIS COLOM FOR RFID TALLY @YUVRAJ 01122022
        "sttr_rfid_tally_close_report                                   VARCHAR(20), " . // ADD THIS COLOM FOR RFID TALLY @YUVRAJ 01122022
        "sttr_location                                                  VARCHAR(64),
sttr_barcode_prefix 						VARCHAR(4),
sttr_barcode 							VARCHAR(64),
sttr_barcode_serial_num 					VARCHAR(64), " . // ADD THIS COLOM FOR BARCODE SERIAL @SHRIKANT 21022023
        "sttr_barcode_tally_profile                                      VARCHAR(24)," . // ADD THIS COLOM FOR MULTI - BARCODE TALLY @YUVRAJ 01122022
        "sttr_barcode_tally_status                                      VARCHAR(2)," . // ADD THIS COLOM FOR MULTI - BARCODE TALLY @YUVRAJ 01122022
        "sttr_barcode_tally_date                                        VARCHAR(20)," . // ADD THIS COLOM FOR MULTI - BARCODE TALLY @YUVRAJ 01122022
        "sttr_barcode_tally_time                                        VARCHAR(20)," . // ADD THIS COLOM FOR MULTI - BARCODE TALLY @YUVRAJ 01122022
        "sttr_add_barcode_date                                          VARCHAR(24)," .
        "sttr_barcode_tally_open_report                                 VARCHAR(20), " . // ADD THIS COLOM FOR RFID TALLY @YUVRAJ 01122022
        "sttr_barcode_tally_close_report                                VARCHAR(20), " .
// Item Combind Code        
...
// Supplier Name reference with Id
        "sttr_brand_id 							VARCHAR(50),
sttr_brand_name 					        VARCHAR(50)," .
// Counter Name @PRIYANKA-16OCT18
        "sttr_counter_name 						VARCHAR(30)," .
        "sttr_counter_id                                                VARCHAR(30)," .
// Barcode Related Fields        
...
// Date Fields       
        ...
        "sttr_other_lang_add_date 					VARCHAR(32)," . //ADDED COLUMN TO STORE OTHER LANGUAGE ADD DATE @AUTHOR:MADHUREE-03DEC2021
        "sttr_bill_date 						VARCHAR(32),
sttr_delivery_date						VARCHAR(32),
sttr_mfg_date 							VARCHAR(32)," .
        "sttr_other_lang_mfg_date					VARCHAR(32)," . //ADDED COLUMN TO STORE OTHER LANGUAGE MFG DATE @AUTHOR:MADHUREE-03DEC2021
        "sttr_exp_date 							VARCHAR(32)," .
        "sttr_as_on_date 						VARCHAR(32)," .
        "sttr_other_lang_exp_date					VARCHAR(32)," . //ADDED COLUMN TO STORE OTHER LANGUAGE EXPIRE DATE @AUTHOR:MADHUREE-03DEC2021
...
sttr_final_fine_wt_by                                           VARCHAR(20)," .
...
// 
// ADDED COLUMN TO STORE HALLMARK CHARGES / HALLMARK CHARGES TYPE / 
// TOTAL HALLMARK CHARGES AND HALLMARK GST @AUTHOR:PRIYANKA-25MAY2022 
        "sttr_hallmark_charges 						VARCHAR(20)," .
        "sttr_hallmark_charges_type                                     VARCHAR(20)," .
        "sttr_hallmark_cgst_per                                         VARCHAR(10)," .
        "sttr_hallmark_sgst_per                                         VARCHAR(10)," .
        "sttr_hallmark_igst_per                                         VARCHAR(10)," .
        "sttr_hallmark_cgst_amt                                         VARCHAR(10)," .
        "sttr_hallmark_sgst_amt                                         VARCHAR(10)," .
        "sttr_hallmark_igst_amt                                         VARCHAR(10)," .
        "sttr_total_hallmark_charges 					VARCHAR(20)," .
        //ADDED COLUMN TO STORE TOTAL HALLMARK CHARGES @AUTHOR:MADHUREE-03JAN2022
// 
...
sttr_tax         						VARCHAR(16),
sttr_gst                                                        VARCHAR(16)," . //ADDED COLUMN GST  @AUTHOR:SHRIKANT-09032023
        "sttr_other_tax_amt         				        VARCHAR(16),
sttr_tot_tax 							VARCHAR(16)," .
// Stone Qyt, Wt & Type
 "sttr_stone_quantity                                                  VARCHAR(15),
...
//Adding Labour cgst, sgst, igst per and charges amount By CHETAN@27JULY2022
"sttr_lab_cgst_per                                              VARCHAR(30),
sttr_lab_cgst_chrg                                              VARCHAR(30),
sttr_lab_sgst_per                                               VARCHAR(30),
sttr_lab_sgst_chrg                                              VARCHAR(30),
sttr_lab_igst_per                                               VARCHAR(30),
sttr_lab_igst_chrg                                              VARCHAR(30)," .
...
//Adding GST per and amt columns
"sttr_lab_gst_per                                               VARCHAR(30),
sttr_lab_gst_amt                                                VARCHAR(30),
sttr_mkg_gst_per                                                VARCHAR(30),
sttr_mkg_gst_amt                                                VARCHAR(30),
sttr_hallmark_gst_per                                           VARCHAR(30),
sttr_hallmark_gst_amt                                           VARCHAR(30),
sttr_other_gst_per                                              VARCHAR(30),
sttr_other_gst_amt                                              VARCHAR(30)," .
// Retail/Wholesale
...
"sttr_quatation_invoice_no 					VARCHAR(40)," .
// Crystal Rate       
...
sttr_stone_live_rate                                            VARCHAR(15)," .
...
sttr_final_tag_weight                                            VARCHAR(15), 
sttr_final_fn_weight                                            VARCHAR(15)," .
//
//
// P.AVG WT / S.AVG WT / F.AVG WT / P.AVG RATE @Author:PRIYANKA-25APR2022
        "sttr_purchase_avg_wt 						VARCHAR(15),
sttr_sell_avg_wt 						VARCHAR(15),
sttr_final_avg_wt 						VARCHAR(15),
sttr_pur_avg_rate 						VARCHAR(15)," .
//
//
// Crystal Y/N
        "sttr_crystal_yn 						VARCHAR(10)," .
// lab charges by
        "sttr_other_charges_by                                          VARCHAR(20)," .
...
// Add New Column for Heaight Code @Author-SHRIKANT-21-02-2023
        "sttr_item_height                                         VARCHAR(16),
...
sttr_total_hallmark_amt                                         VARCHAR(10),
...
sttr_making_dis_set_ind                                         VARCHAR(10),
sttr_making_dis_set_per                                         VARCHAR(10),
sttr_mkg_per_old                                                 VARCHAR(10)," .
...
sttr_online_product_disc                                        VARCHAR(10),
sttr_online_product_price_bounce                                        VARCHAR(10),
sttr_disc_product_discount                                      VARCHAR(10),
sttr_disc_active                                                VARCHAR(10)," .
// staff sell the product it got commissio on that product @AUTHOR:SHRIKANT 16JAN2023
        "sttr_product_commission                                       VARCHAR(30)," .
...
sttr_pkt_wt_opration1 						VARCHAR(15),
sttr_pkt_wt_opration2 						VARCHAR(15),
sttr_pkt_wt_opration3 						VARCHAR(15),
sttr_pkt_wt_opration4 						VARCHAR(15),
sttr_pkt_wt_opration5 						VARCHAR(15),
...
sttr_melting_status 						VARCHAR(10),
sttr_melting_date 						VARCHAR(32)," .
// 
// FOR MELTING REFERENCE NUMBER @AUTHOR:PRIYANKA-12JUNE2023 
"sttr_ref_invoice_no                                            VARCHAR(15),
...
sttr_return_panel                                               VARCHAR(20)," .
//
// Column added for online options:HEMA-19NOV2019        
        "sttr_online_option                                             VARCHAR(100),
sttr_online_qty                                                 INT,
sttr_omecom_status                                              VARCHAR(10),
sttr_omecom_prod_type                                             VARCHAR(20)," . //ADDED COLUMN TO STORE ECOM PRODUCT SECTION TO DISPLAY @AUTHOR:MADHUREE-22MARCH2022
...
//
// Added new columns for Stock Transfer Counter and Staff History @AUTHOR:PRIYANKA-09DEC2021
        "sttr_stock_trans_counter_history                               VARCHAR(300),
sttr_stock_trans_staff_history                                  VARCHAR(300),
sttr_stock_transfer_status                                      VARCHAR(25),
sttr_stock_transfer_panel                                       VARCHAR(25)," .
//
// Added new columns for Stock Transfer - Previous Firm / Approval Pending Status / Approved Status @AUTHOR:PRIYANKA-20JUNE2022
        "sttr_stock_transfer_previous_firm_id                          VARCHAR(16),
sttr_stock_transfer_return_firm_id                             VARCHAR(16),
sttr_stock_transfer_approval_status                            VARCHAR(45),
sttr_pre_voucher_no                                            VARCHAR(20),
sttr_voucher_no                                                VARCHAR(10),
sttr_voucher_history                                           VARCHAR(300),
sttr_stock_transfer_lot_status                                 VARCHAR(45),
sttr_stock_trans_doc_no                                        VARCHAR(20),
sttr_stock_trans_sender_name                                   VARCHAR(20),
sttr_stock_trans_receiver_name                                 VARCHAR(20),
sttr_stock_transfer_name                                       VARCHAR(20),
sttr_stock_transfer_narration                                  VARCHAR(45),
sttr_stock_transfer_prev_counter_name                          VARCHAR(20),
sttr_stock_transfer_prev_staff_id                              VARCHAR(20)," .
        //Adding column for imitation calculation
        "sttr_val_cal_by                                               VARCHAR(20)," .
//
...
// COLUMN ADDED FOR PACKING LIST REFERENCE NUMBER FOR IDENTIFYING LAST ADDED ELEMENT @AUTHOR:MADHUREE-06JAN2020
 ...
 sttr_stock_transfer_success_status                                     VARCHAR(15),
...
// COLUMN ADDED TO ADD DIFFERECE IN WT BY SIZE,@AUTHOR:HEMA-6AUG2020
        ...
        // COLUMN ADDED FOR PRODUCT DESCRIPTION BY CHETAN 17MAY2023
        "sttr_product_desc                                              LONGBLOB," .
        // COLUMN ADDED FOR PRODUCT DESCRIPTION BY CHETAN 17MAY2023
        "sttr_product_hashtags                                          VARCHAR(200)," .
        "sttr_occasion_hashtags                                          VARCHAR(200)," .
    //
    // For Hall Marking Stock Return User Id and Status @AUTHOR:PRIYANKA-06SEP2021
        "sttr_hallmark_payment_status 					VARCHAR(20)," .
        "sttr_hallmark_utin_id                                          VARCHAR(20)," .
        "sttr_hallmark_user_id                                          VARCHAR(16),
         sttr_hallmark_status                                            VARCHAR(32),
         sttr_hallmark_send_date                                         VARCHAR(32),
         sttr_purches_discount_per                                         VARCHAR(32),
         sttr_purches_discount_amt                                         VARCHAR(32),
         sttr_hallmark_receive_date                                      VARCHAR(32),
         sttr_hallmark_lot_number                                        VARCHAR(16)," .
    //        
...
//COLUMN ADDED TO ADD CERTIFICATE NUMBER : AUTHOR @DARSHANA 22 JUNE 2021
        ...
        "sttr_laboratory                                               VARCHAR(20)," . //ADDED STONE LABORATORY @SIMRAN:17JAN2023
        "sttr_omprocess_date                                            VARCHAR(12)," .
        "sttr_similar_prod_id                                           VARCHAR(1000)," . // COLUMN ADDED TO STORE SIMILAR PRODUCT ID @AUTHOR:MADHUREE-05AUGUST2022
        "sttr_min_size                                                  VARCHAR(20)," . // COLUMN ADDED TO STORE PRODUCT MINIMUM SIZE @AUTHOR:MADHUREE-22SEPTEMBER2022
        "sttr_max_size                                                  VARCHAR(20)," . // COLUMN ADDED TO STORE PRODUCT MAXIMUM SIZE @AUTHOR:MADHUREE-22SEPTEMBER2022
        "sttr_size_type                                                 VARCHAR(20)," . // COLUMN ADDED TO STORE PRODUCT SIZE TYPE @AUTHOR:MADHUREE-22SEPTEMBER2022
        "sttr_min_weight                                                VARCHAR(20)," . // COLUMN ADDED TO STORE PRODUCT MINIMUM WEIGHT @AUTHOR:MADHUREE-22SEPTEMBER2022
        "sttr_max_weight                                                VARCHAR(20)," . // COLUMN ADDED TO STORE PRODUCT MAXIMUM WEIGHT @AUTHOR:MADHUREE-22SEPTEMBER2022
        "sttr_final_billing_Amt                                         VARCHAR(20)," . // COLUMN ADDED TO BILLING PRICE FOR RETAIL SOFTWARE @AUTHOR:YUVRAJ-06SUPTEMBER2022
        "sttr_late_pay_wstg_date                                        VARCHAR(12)," . //COLUMN ADDED TO STORE LATE PAYMENT DUE DATE @AUTHOR:RENUKA_SHARMA-06FEB2023        
        "sttr_excel_import                                              VARCHAR(12)," . //COLUMN ADDED TO CHECK STOCK ADDED FROM FILE IMPORT @AUTHOR:SANSKRUTI-10JULY2023 
        "sttr_image_ext                                                 VARCHAR(12)," .
        ...
        "sttr_24k_rate                                                  VARCHAR(10)," .
        "sttr_order_status                                              VARCHAR(16),".
        "sttr_ecom_upd_status                                            VARCHAR(16),".
        "sttr_mrp2                                                      VARCHAR(16),".//hrushali.
        "sttr_franchise_price                                            VARCHAR(16),".//hrushali
        "sttr_dealer_price                                            VARCHAR(16),".//hrushali
        "sttr_discounted_price                                            VARCHAR(16),".//hrushali.

        "sttr_ratecut_norate_option                                            VARCHAR(16),";
        if ($_SESSION['sessionProdName'] == 'OMRETL') {
            
    $query = $query .
            "sttr_stock_sub_type                                            VARCHAR(20)," .
            "last_column VARCHAR(1),UNIQUE KEY (sttr_barcode, sttr_barcode_serial_num, sttr_stock_sub_type)) AUTO_INCREMENT = 1";
} else {

    $query = $query . "last_column VARCHAR(1))AUTO_INCREMENT = 1";
        }
