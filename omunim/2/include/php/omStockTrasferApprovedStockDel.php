...
/*
 * **************************************************************************************
 * @Description: STOCK TRANSFER - APPROVED STOCK DELETE 
 *               TRANSFER STOCK TO APPROVAL PENDING LIST @Author:PRIYANKA-20JUNE2022
 * **************************************************************************************
 *
 * Created on JUNE 20, 2022 03:59:00 PM
 *
 * @FileName: omStockTrasferApprovedStockDel.php
...
//echo 'sttrId == ' . $sttrId . '</br>'; die;
//
//
// *****************************************************************************************************
// START TO ADD CODE FOR STOCK TRANSFER APPROVED LIST
// DELETE STOCK FROM APPROVED LIST AND TRANSFER TO APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************
//
//
...
//
//
// ADDED CODE TO DELETE STOCK FROM STOCK TABLE AND TRANSFER STOCK TO APPROVAL PENDING LIST  @AUTHOR-PRIYANKA-21JUNE2022
stock('delete', array(), $sttrId, 'tagEntryDel');
//
//
//
//
// ADDED CODE TO UPDATE STATUS AFTER DELETE STOCK FROM APPROVED LIST 
// AND TRANSFER STOCK TO APPROVAL PENDING LIST  @AUTHOR-PRIYANKA-21JUNE2022
$query = "UPDATE stock_transaction SET sttr_stock_transfer_approval_status = 'StockTransferApprovalPendingStock' "
...
//
//
$sslg_trans_sub = 'STOCK TRANSFER - APPROVED STOCK DELETED';
...
//
//
$showDiv = 'StockApprovedDeletedSuccessfully';
//
//
// *****************************************************************************************************
// END TO ADD CODE FOR STOCK TRANSFER APPROVED LIST
// DELETE STOCK FROM APPROVED LIST AND TRANSFER TO APPROVAL PENDING LIST @AUTHOR-PRIYANKA-21JUNE2022
// *****************************************************************************************************
//
//
