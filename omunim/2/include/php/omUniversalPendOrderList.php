 ...
 *
 * @FileName: omUniversalPendOrderList.php
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td valign="middle" align="left" width="70%">
                <div class="main_link_orange16">NEW ORDER LIST<span class="textLabel14CalibriGreyMiddle">
...
// Where Clause Condition 
 $_SESSION['tableWhere'] = "sttr_owner_id = '$_SESSION[sessionOwnerId]' AND sttr_firm_id IN ($strFrmId) "
                        ...
                        . "AND (sttr_delivery_status NOT IN ('DELIVERED') OR sttr_delivery_status IS NULL) "
                        . "AND (sttr_assign_status = 'READY TO ASSIGN' OR "
                        . "sttr_assign_status = '' OR sttr_assign_status IS NULL) "
